                            ...
                            if ($sectors_enable_switch == 'on') {
                                ...
                                if ($sector_selct_method == 'multi' || $sector_selct_method == 'multi_req') {
                                    ...
                                    if ($sector_selct_method == 'multi_req') {
                                        $selct_sector_title = esc_html__('Job Sector *', 'wp-jobsearch');
                                        $selct_sector_class = 'jobsearch-req-field multiselect-req selectize-select';
                                    }
                                    ...
                                    <li class="<?php echo($fil_col_class) ?>">
                                        ...
                                        <div class="jobsearch-profile-select">
                                            ...
                                            if (!empty($all_sectors)) {
                                                ?>
                                                <select id="job-sector-multi" name="job_sector[]" class="<?php echo ($selct_sector_class) ?>" multiple="" placeholder="<?php esc_html_e('Select Job Sectors', 'wp-jobsearch') ?>">
                                                    <?php
                                ...
                                if ($job_types_selection == 'multi') {
                                    ...
                                    <li class="<?php echo($fil_col_class) ?>">
                                        ...
                                        <div class="jobsearch-profile-select">
                                            ...
                                            if (!empty($all_types)) {
                                                ?>
                                                <select id="job-type-multi" name="job_type[]" class="<?php echo ($selct_type_class) ?>" multiple="" placeholder="<?php esc_html_e('Select Job Types', 'wp-jobsearch') ?>">
                                                    <?php
                            ...
                            if (isset($job_apply_switch) && $job_apply_switch == 'on') {
                                ...
                                if ($dropdown_flag) {
                                    ...
                                    <li class="jobsearch-column-6">
                                        ...
                                        <div class="jobsearch-profile-select">
                                            <select id="jobsearch_job_apply_type"<?php echo ($jobapply_type_req == 'on' ? ' required="required"' : '') ?> class="selectize-select" name="job_apply_type"<?php echo ($jobapply_type_req == 'on' ? ' placeholder="' . esc_html__('Select Apply Type', 'wp-jobsearch') . '"' : '') ?>>
                                                <?php
                ...
                if (!$is_candidate) {
                    if (isset($job_detail_tab) && $job_detail_tab && !isset($_GET['step'])) {
                        ...
                        if ($is_updating) {
                            ...
                            ob_start();
                            ?>
                            <input type="submit" class="jobsearch-employer-profile-submit jobsearch-postjob-btn" value="<?php echo ($_updtjob_title) ?>">
                            <?php
