<?php
if (!class_exists('jobsearch_candidate_pdf_resume_template_ten')) {

    class jobsearch_candidate_pdf_resume_template_ten
    {
        ...
        public function jobsearch_single_candidate_resume_form()
        {
            ...
            ?>
            <form id="pdf_cand_generate_form_templt_ten" method="post" enctype="multipart/form-data"
                  style="display: none">
                <input type="text" name="jobsearch_single_pdf_cand_id_templt_ten" value="">
                <input type="submit" class="btn btn-default" name="pdf_cand_generate_form_submit_templt_ten"
                       value="Generate PDF">
            </form>
            <script type="text/javascript">
                jQuery(document).on('click', '.jobsearch-get-cand-id-templt-ten', function () {
                    ...
                    request.done(function (response) {
                        if (typeof response.res !== 'undefined' && response.res == true) {
                            ...
                            //
                            jQuery("input[name=jobsearch_single_pdf_cand_id_templt_ten]").val(_cand_id);
                            jQuery("input[name=pdf_cand_generate_form_submit_templt_ten]").trigger('click')
                        }
                    });
        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_ten'])) {

                $candidate_id = $_POST['jobsearch_single_pdf_cand_id_templt_ten'];
                $stylesheet = file_get_contents($jobsearch_resume_export->jobsearch_resume_export_get_path('css/jobsearch-mpdf-style-template-ten.css'));
                ...
                <div class="pdf-style11-left-content"
                     style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_11/pattren.jpg') ?>');">
                    <div class="pdf-style11-content-dcp-title"><?php echo($user_displayname) ?></div>
                    <div class="pdf-style11-content-dcp-sub"><?php echo($candidate_company_str) ?></div>
                    <br>
                ...
                <div class="pdf-style11-right-bar">
                    <?php if (!empty($profile_image)) { ?>
                        <div class="pdf-style11-bar-thumb">
                            <div style="background-image: url('<?php echo($profile_image) ?>');"></div>
                        </div>
                    <?php } ?>
                    <div class="pdf-style11-bar-inner">
                        <div class="pdf-style11-bar-title"><?php echo esc_html__('Who am i', 'jobsearch-resume-export') ?></div>
                        <div class="pdf-style11-bar-line"></div>
                        <div class="pdf-style11-bar-pera"><?php echo($candidate_content) ?></div>

                        <!--Candidate Custom Fields-->
                        <?php echo self::jobsearch_resume_candidate_custom_fields($candidate_id) ?>

                        <div class="pdf-style11-bar-heading"><?php echo esc_html__('Contact me', 'jobsearch-resume-export') ?></div>
                        <div class="pdf-style11-social-list">

                            <?php if (!empty($phone_number)) { ?>
                                <div class="pdf-style11-social-list-inn">
                                    <div class="pdf-style11-social-icon">
                                        <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_11/phone.png') ?>">
                                    </div>
                                    <div class="pdf-style11-social-text">
                                        <div class="pdf-style11-social-title">+<?php echo($phone_number) ?></div>
                                    </div>
                                </div>
                            <?php } ?>
                            <div class="pdf-style11-social-list-inn">
                                <div class="pdf-style11-social-icon"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_11/marker.png') ?>"
                                            alt=""></div>
                                <div class="pdf-style11-social-text">
                                    <div class="pdf-style11-social-title"><?php echo($candidate_address) ?></div>
                                </div>
                            </div>
                            <?php if (!empty($cand_email)) { ?>
                                <div class="pdf-style11-social-list-inn">
                                    <div class="pdf-style11-social-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_11/envelope.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style11-social-text">
                                        <div class="pdf-style11-social-title"><?php echo($cand_email) ?></div>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
        ...
        public function jobsearch_candidate_resume_bulk_export_template_ten($candidate_id)
        {
        ...
        public static function jobsearch_resume_candidate_custom_fields($candidate_id)
        {
            ...
            if (!empty($custom_all_fields)) { ?>
                ...
                <div class="pdf-style11-bar-heading"><?php echo esc_html__('About Me', 'jobsearch-resume-export'); ?></div>
                <div class="pdf-style11-bar-services">
                    <?php
                    $fields_data = [];
                    foreach ($custom_all_fields as $info) {
                        ...
                        if ($type == 'heading' && $field_for_non_reg_user != 'admin_view_only') { ?>
                            ...
                            <div class="pdf-style11-bar-heading"><?php echo ($field_label); ?></div>
                            <div class="pdf-style11-bar-services">
                        ...
                        <?php } else  if ($type == 'checkbox' && $field_for_non_reg_user != 'admin_view_only') {
                            ...
                            $icon_type = strpos($icon, 'careerfy') !== false ? 'careerfy' : 'jobsearch';
                            ?>
                            <div class="pdf-style11-bar-services-list">
                                <div class="pdf-style11-bar-icon">
                                    <div style="font-family: <?php echo($icon_type) ?>"><?php echo jobsearch_get_font_code($icon) ?></div>
                                </div>
                                <div class="pdf-style11-bar-services-text">
                                    <div class="pdf-style11-bar-services-title"><?php echo($field_label) ?></div>
                                    <?php if (is_array($field_value) && count($field_value) > 0) {
                                        foreach ($field_value as $val) {
                                            if($type == 'upload_file'){
                                                $img_path = str_replace(get_site_url(),ABSPATH,$val);
                                                ?>
                                                <div class="pdf-style11-bar-services-sub"><img src="<?php echo($img_path) ?>"></div>
                                            <?php } else { ?>
                                                <div class="pdf-style11-bar-services-sub"><?php echo($val) ?></div>
                                            <?php } ?>
                                        <?php }
                                    } else {
                                        $field_value = $type == 'date' ? date_i18n($info['date-format'],$field_value) : $field_value;
                                        ?>
                                        <div class="pdf-style11-bar-services-sub"><?php echo($field_value) ?></div>
                                    <?php } ?>
                                </div>
                            </div>
                        <?php }
                    ...
                    if (count($fields_data) > 0) {
                        foreach ($fields_data as $fields) { ?>
                            <div class="pdf-style11-bar-services-list">
                                ...
                                <?php } ?>
                                <div class="pdf-style11-bar-services-text">
                                    <div class="pdf-style11-bar-services-title"><?php echo($fields['label']) ?></div>
                                    <div class="pdf-style11-bar-services-sub"><?php echo($fields['value']) ?></div>
                                </div>
                            </div>
                        <?php } ?>
                    <?php } ?>
        ...
        public function jobsearch_resume_candidate_experience($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style11-section-heading"><?php echo esc_html__('Experience', 'jobsearch-resume-export'); ?></div>
                <br>
                <div class="pdf-style11-content-list">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style11-content-list-inn <?php echo ($x == $length) ? 'last' : '' ?>">
                            <div class="pdf-style11-content-list-check">
                                <div style=" background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_11/check-img.png') ?>');"></div>
                            </div>
                            <div class="pdf-style11-content-list-inn-left">
                                <div class="pdf-style11-content-list-title"><?php echo jobsearch_esc_html($exfield) ?></div>
                                <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style11-content-list-sub"><?php echo jobsearch_esc_html($experience_end_companyfield_val) ?>
                                ...
                                <?php } ?>
                                <div class="pdf-style11-content-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                            </div>
                        </div>
                        <?php
                        $exfield_counter++;
        ...
        public static function jobsearch_resume_candidate_education($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style11-section-heading"><?php echo esc_html__('Education', 'jobsearch-resume-export'); ?></div>
                <div class="pdf-style11-education-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style11-education-list-inn">
                            <?php
                            if ($edu_start_metaexist) {
                                if ($education_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style11-education-list-sub"><?php echo($exfield) ?>
                                ...
                                <div class="pdf-style11-education-list-sub"><?php echo($exfield) ?>
                                    &nbsp;<span><?php echo($education_yearfield_val) ?></span></div>
                            <?php } ?>
                            <div class="pdf-style11-education-list-pera"><?php echo($exfield_val) ?></div>
                        </div>
        ...
        public static function jobsearch_resume_candidate_awards($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style11-section-heading"><?php echo esc_html__('Honors & Awards', 'jobsearch-resume-export'); ?></div>
                <br>
                <div class="pdf-style11-content-list">
                    <?php
                    $exfield_counter = 0;
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style11-content-list-inn <?php echo ($x == $length) ? 'last' : '' ?>">
                            ...
                            <div class="pdf-style11-content-list-inn-left">
                                <div class="pdf-style11-content-list-title"><?php echo($exfield) ?></div>
                                <div class="pdf-style11-content-list-sub"><?php echo jobsearch_esc_html($award_yearfield_val) ?></div>
                                <div class="pdf-style11-content-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                            </div>
                        </div>
                        <?php $exfield_counter++;
        ...
        public static function jobsearch_resume_candidate_expertise($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <br>
                <div class="pdf-style11-section-heading"><?php echo esc_html__('Skills', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style11-skills-wrap">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style11-skills">
                            <div class="pdf-style11-skills-left"><?php echo($exfield) ?></div>
                            <div class="pdf-style11-skills-line">
                                <div class="pdf-style11-skills-inn1"></div>
                                <div class="pdf-style11-skills-inn2"
        ...
        public static function jobsearch_resume_candidate_languages($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <br>
                <div class="pdf-style11-section-heading"><?php echo esc_html__('Languages', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style11-skills-wrap">
                    <?php
                    $exfield_counter = 0;
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style11-skills">
                            <div class="pdf-style11-skills-left"><strong><?php echo($exfield) ?></strong> <?php echo($lang_level_str) ?></div>
                            <div class="pdf-style11-skills-line">
                                <div class="pdf-style11-skills-inn1"></div>
                                <div class="pdf-style11-skills-inn2"
        ...
        public static function jobsearch_resume_cand_portfolio($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style11-section-heading"><?php echo esc_html__('Portfolio', 'jobsearch-resume-export'); ?></div>
                <br>
                <?php
                $exfield_counter = 0;
                foreach ($exfield_list as $exfield) {
        ...
        {
            global $jobsearch_resume_export;
            $skills_list = jobsearch_resume_export_job_get_all_skills($candidate_id, '', '', '', '', '<div class="pdf-style11-expertise-list-inn"><div class="pdf-style11-expertise-list-thumb"><img src="' . $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_11/check-min.png') . '"></div>', '</div>', 'candidate');
            $skills_list = apply_filters('jobsearch_cand_detail_skills_list_html', $skills_list, $candidate_id);

            if (!empty($skills_list)) { ?>
                <div class="pdf-style11-section-heading"><?php echo esc_html__('Skills', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style11-expertise-list">
                    <?php if ($skills_list != '') { ?>
...
global $jobsearch_resume_pdf_template_ten;
$jobsearch_resume_pdf_template_ten = new jobsearch_candidate_pdf_resume_template_ten();