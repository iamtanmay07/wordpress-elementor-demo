        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_three'])) {
                ...
                <div class="pdf-style3-thumb">
                    ...
                    <div class="pdf-style3-thumb-sub">Archaeologist</div>
                </div>
                    ...
                    <?php } else if ($type == 'checkbox' && $field_for_non_reg_user != 'admin_view_only') {
                        ...
                        <div class="pdf-style3-bar-services-list">
                            ...
                            <div class="pdf-style3-bar-services-text">
                                <div class="pdf-style3-bar-services-title"><?php echo($info['label']) ?></div>
                ...
                <div class="pdf-style3-timeline-list-wrapper">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style3-timeline-list <?php echo ($length == $x) ? 'last' : '' ?> ">
                            <div class="pdf-style3-timeline-circle">
                            ...
                            <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                <div class="pdf-style3-timeline-date"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?></div>
                            <?php } else { ?>
                                <div class="pdf-style3-timeline-date"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . ($experience_end_datefield_val != '' ? ' - ' . date('Y', strtotime($experience_end_datefield_val)) : '') ?></div>
                            <?php } ?>
                            <div class="pdf-style3-timeline-pera"><?php echo jobsearch_esc_html($exfield_val) ?>
                            </div>
                        </div>
                        ...
                        <div class="pdf-style3-timeline-list <?php echo ($length == $x) ? 'last' : '' ?>">
                            ...
                            if ($edu_start_metaexist) {
                                if ($education_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style3-timeline-date"><?php echo ($education_start_datefield_val != '' ? date('Y', strtotime($education_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'wp-jobsearch') ?></div>
                                <?php } else { ?>
                                    <div class="pdf-style3-timeline-date"><?php echo ($education_start_datefield_val != '' ? date('Y', strtotime($education_start_datefield_val)) : '') . ($education_end_datefield_val != '' ? ' - ' . date('Y', strtotime($education_end_datefield_val)) : '') ?></div>
                                    <?php
                                }
                            } else { ?>
