<?php
if (!class_exists('jobsearch_candidate_pdf_resume_template_four')) {

    class jobsearch_candidate_pdf_resume_template_four
    {
        ...
        public function jobsearch_single_candidate_resume_form()
        {
            ...
            ?>
            <form id="pdf_cand_generate_form_templt_four" method="post" enctype="multipart/form-data" style="display: none">
                <input type="text" name="jobsearch_single_pdf_cand_id_templt_four" value="">
                <input type="submit" class="btn btn-default" name="pdf_cand_generate_form_submit_templt_four"
                       value="Generate PDF">
            </form>
            <script type="text/javascript">
            jQuery(document).on('click', '.jobsearch-get-cand-id-templt-four', function () {
                    ...
                    request.done(function (response) {
                        if (typeof response.res !== 'undefined' && response.res == true) {
                            ...
                            //
                            jQuery("input[name=jobsearch_single_pdf_cand_id_templt_four]").val(_cand_id);
                            jQuery("input[name=pdf_cand_generate_form_submit_templt_four]").trigger('click')
                        }
                    });
        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_four'])) {

                $candidate_id = $_POST['jobsearch_single_pdf_cand_id_templt_four'];
                $stylesheet = file_get_contents($jobsearch_resume_export->jobsearch_resume_export_get_path('css/jobsearch-mpdf-style-template-four.css'));
                ...
                ob_start();
                ?>
                <div class="pdf-style5-page-wrapper">
                    <div class="pdf-style5-left-bar">
                        <?php if (!empty($profile_image)) { ?>
                            <div class="pdf-style5-thumb"><img src="<?php echo($profile_image) ?>" alt=""></div>
                        <?php } ?>
                        <div class="pdf-style5-thumb-title"
                             style="font-family: Montserrat"><?php echo($user_displayname) ?></div>

                        <?php if (!empty($candidate_company_str)) { ?>
                            <div class="pdf-style5-thumb-sub"><?php echo($candidate_company_str) ?></div>
                        <?php } ?>

                        <div class="pdf-style5-pera-title"><?php echo esc_html__('About Me', 'jobsearch-resume-export') ?></div>
                        <div class="pdf-style5-peragraph"><?php echo($candidate_content) ?>
                        </div>

                        <br><br><br>
                        <?php if (!empty($user_dob_whole)) { ?>
                            <div class="pdf-style5-bar-list">
                                <div class="pdf-style5-bar-list-title"><?php echo esc_html__('DOB:', 'jobsearch-resume-export') ?></div>
                                <div class="pdf-style5-bar-list-sub"><?php echo($user_dob_whole) ?></div>
                            </div>
                        <?php } ?>
                        <?php if (!empty($candidate_address)) { ?>
                            <div class="pdf-style5-bar-list">
                                <div class="pdf-style5-bar-list-title"><?php echo esc_html__('Address:', 'jobsearch-resume-export') ?></div>
                                <div class="pdf-style5-bar-list-sub"><?php echo($candidate_address) ?></div>
                            </div>
                        <?php } ?>
                        <?php if (!empty($phone_number)) { ?>
                            <div class="pdf-style5-bar-list">
                                <div class="pdf-style5-bar-list-title"><?php echo esc_html__('Phone:', 'jobsearch-resume-export') ?></div>
                                <div class="pdf-style5-bar-list-sub"><?php echo($phone_number) ?></div>
                            </div>
                        <?php } ?>
                        <?php if (!empty($cand_email)) { ?>
                            <div class="pdf-style5-bar-list">
                                <div class="pdf-style5-bar-list-title"><?php echo esc_html__('Email:', 'jobsearch-resume-export') ?></div>
                                <div class="pdf-style5-bar-list-sub"><?php echo($cand_email) ?></div>
                            </div>
                        <?php } ?>

                        <?php if (!empty($user_website)) { ?>
                            <div class="pdf-style5-bar-list">
                                <div class="pdf-style5-bar-list-title"><?php echo esc_html__('Website:', 'jobsearch-resume-export') ?></div>
                                <div class="pdf-style5-bar-list-sub"><?php echo($user_website) ?></div>
                            </div>
                        <?php } ?>
                    </div>

                    <div class="pdf-style5-right-content">
                ...
                $mpdf->SetDefaultBodyCSS('background-color', '#f4f3f2');
        ...
        public function jobsearch_candidate_resume_bulk_export_template_four($candidate_id)
        {
        ...
        $mpdf->defaultfooterline = 0;
            ...
            <div class="pdf-style5-page-wrapper">
                    <div class="pdf-style5-left-bar">
                        ...
                        <div class="pdf-style5-pera-title"><?php echo esc_html__('About Me', 'jobsearch-resume-export') ?></div>
                        <div class="pdf-style5-peragraph"><?php echo($candidate_content) ?></div>
        ...
        public static function jobsearch_resume_candidate_custom_fields($candidate_id)
        {
            ...
            if (!empty($custom_all_fields)) {
                ...
                ?>
                <div class="pdf-style5-content-title"><?php echo esc_html__('About me', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style5-bar-services">
                    <?php
                    $fields_data = [];
                    ...
                    if ($type == 'heading' && $field_for_non_reg_user !='admin_view_only') { ?>
                        ...
                        <div class="pdf-style5-content-title"><?php echo($field_label) ?></div>
                        <div class="pdf-style5-bar-services">
                    ...
                    <?php } else if ($type == 'checkbox' && $field_for_non_reg_user !='admin_view_only') {
                        ...
                        $fields_data[] = array(
                            ...
                            <div class="pdf-stylefield-bar-servicesfull-list">
                                ...
                                <div class="pdf-stylefield-bar-servicesfull-text">
                                    <div class="pdf-style5-bar-services-title"><?php echo($field_label) ?></div>
                                </div>
                                <?php
                        ...
                        <?php } else { ?>
                            <div class="pdf-style5-bar-services-list">
                                <div class="pdf-style5-bar-icon">
                                    <div style="font-family: <?php echo ($icon_type) ?>"><?php echo jobsearch_get_font_code($icon) ?></div>
                                </div>
                                <div class="pdf-style5-bar-services-text">
                                    <div class="pdf-style5-bar-services-title"><?php echo($field_label) ?></div>
                                    <?php if (is_array($field_value) && count($field_value) > 0) {
                                    foreach ($field_value as $val) { ?>
                                        <div class="pdf-style5-bar-services-sub"><?php echo($val) ?></div>
                                    <?php }
                                } else {
                                        $field_value = $type == 'date' ? date_i18n($info['date-format'],$field_value) : $field_value;
                                        ?>
                                    <div class="pdf-style5-bar-services-sub"><?php echo($field_value) ?></div>
                                <?php } ?>
                     ...
                     <?php
                      ...
                      <div class="pdf-style10-bar-services-list">
                      <?php if (!empty($fields['icon'])) { ?>
                            <div class="pdf-style10-bar-icon">
                                <div style="font-family: <?php echo($fields['icon_type']) ?>"><?php echo($fields['icon']) ?></div>
                            </div>
                            <?php } ?>
                            <div class="pdf-style10-bar-services-text">
                                <div class="pdf-style10-bar-services-title"><?php echo($fields['label']) ?></div>
                                <div class="pdf-style10-bar-services-sub"><?php echo($fields['value']) ?></div>
                            </div>
                      </div>
                    <?php } ?>
                <?php } ?>
        ...
        public function jobsearch_resume_candidate_experience($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style5-content-title"><?php echo esc_html__('Job Experiences', 'jobsearch-resume-export'); ?></div>
                <div class="pdf-style5-experience-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style5-experience-inner <?php echo ($length == $x) ? 'last' : '' ?>">
                            <div class="pdf-style5-experience-circle">
                                <div style="background: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_4/circle-list.png') ?>')"></div>
                            </div>
                            <div class="pdf-style5-experience-title"><?php echo jobsearch_esc_html($exfield) ?></div>
                            <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                <div class="pdf-style5-experience-sub"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?>
                                    <span>/ &nbsp; &nbsp; <?php echo($experience_end_companyfield_val) ?></span></div>
                            <?php } else { ?>
                                <div class="pdf-style5-experience-sub"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . ($experience_end_datefield_val != '' ? ' - ' . date('Y', strtotime($experience_end_datefield_val)) : '') ?>
                                    <span>/ &nbsp; &nbsp; <?php echo($experience_end_companyfield_val) ?></span></div>
                            <?php } ?>
                            <div class="pdf-style5-experience-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                        </div>
                        <?php
                        $x++;
                        $exfield_counter++;
        ...
        public static function jobsearch_resume_candidate_education($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style5-content-title"><?php echo esc_html__('Education', 'jobsearch-resume-export'); ?></div>
                <div class="pdf-style5-education-list">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style5-education-inner">
                            <div class="pdf-style5-education-circle">
                                <div style="background: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_4/circle-list.png') ?>')"></div>
                            </div>
                            <div class="pdf-style5-education-title"><?php echo($exfield) ?></div>
                            <div class="pdf-style5-education-sub"><?php echo($education_academyfield_val) ?></div>
                            <?php
                            if ($edu_start_metaexist) {
                                if ($education_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style5-education-sub"><?php echo ($education_start_datefield_val != '' ? date('Y', strtotime($education_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'wp-jobsearch') ?></div>
                                <?php } else { ?>
                                    <div class="pdf-style5-education-sub"><?php echo ($education_start_datefield_val != '' ? date('Y', strtotime($education_start_datefield_val)) : '') . ($education_end_datefield_val != '' ? ' - ' . date('Y', strtotime($education_end_datefield_val)) : '') ?></div>
                                    <?php
                                }
                            } else { ?>
                                <div class="pdf-style5-education-sub"><?php echo($education_yearfield_val) ?></div>
                            <?php } ?>
                            <div class="pdf-style5-education-pera"><?php echo($exfield_val) ?></div>
                        </div>
                        <?php $exfield_counter++;
                        $x++;
                    } ?>
        ...
        public static function jobsearch_resume_candidate_awards($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
            <div class="pdf-style5-content-title"><?php echo esc_html__('Honors & Awards', 'jobsearch-resume-export'); ?></div>
                <div class="pdf-style5-education-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style5-education-title"><?php echo jobsearch_esc_html($exfield) ?></div>
                        <div class="pdf-style5-education-sub"><?php echo jobsearch_esc_html($award_yearfield_val) ?></div>
                        <div class="pdf-style5-education-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                        </div>
        ...
        public static function jobsearch_resume_candidate_expertise($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style5-content-title"><?php echo esc_html__('EXPERTISE', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style5-skills-wrap">
                    <div class="pdf-style5-skills-circle">
                        <div style="background: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_4/circle-list.png') ?>')"></div>
                    </div>
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                    $length = count($exfield_list);
                    $second_last = count($exfield_list) - 1;
                    $third_last = count($exfield_list) - 2;
                    foreach ($exfield_list as $exfield) {
                        $rand_num = rand(1000000, 99999999);
                        ...
                        ?>
                        <div class="pdf-style5-skills-list <?php echo ($length == $x) || ($length == $second_last) || ($length == $third_last) ? 'last' : '' ?>">
                            <div class="pdf-style5-skills-title"><?php echo($exfield) ?></div>
                            <div class="pdf-style5-skills-line">
                                <div class="pdf-style5-skills-inn1"></div>
                                <div class="pdf-style5-skills-inn2"
        ...
        public static function jobsearch_resume_candidate_languages($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style5-content-title"><?php echo esc_html__('Languages', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style5-skills-wrap">
                    <div class="pdf-style5-skills-circle">
                        <div style="background: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_4/circle-list.png') ?>')"></div>
                    </div>
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style5-skills-list <?php echo ($length == $x) || ($length == $second_last) || ($length == $third_last) ? 'last' : '' ?>">
                            <div class="pdf-style5-skills-title">
        ...
        public static function jobsearch_resume_cand_portfolio($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style5-content-title"><?php echo esc_html__('Portfolio', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style5-skills-wrap">
                    <div class="pdf-style5-skills-circle">
                        <div style="background: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_4/circle-list.png') ?>')"></div>
                    </div>
        ...
        public static function jobsearch_resume_candidate_skills($candidate_id)
        {
            ...
            if (!empty($skills_list)) { ?>
                <div class="pdf-style5-content-title"><?php echo esc_html__('Skills', 'jobsearch-resume-export') ?></div>
                 <div class="pdf-style5-skills-circle">
                        <div style="background: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_4/circle-list.png') ?>')"></div>
                    </div>
...
global $jobsearch_resume_pdf_template_four;
$jobsearch_resume_pdf_template_four = new jobsearch_candidate_pdf_resume_template_four();