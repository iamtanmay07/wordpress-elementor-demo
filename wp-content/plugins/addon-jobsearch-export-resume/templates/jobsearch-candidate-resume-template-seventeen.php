<?php
if (!class_exists('jobsearch_candidate_pdf_resume_template_seventeen')) {

    class jobsearch_candidate_pdf_resume_template_seventeen
    {
        ...
        public function jobsearch_single_candidate_resume_form()
        {
            ...
            ?>
            <form id="pdf_cand_generate_form_templt_seventeen" method="post" enctype="multipart/form-data"
                  style="display: none">
                <input type="text" name="jobsearch_single_pdf_cand_id_templt_seventeen" value="">
                <input type="submit" class="btn btn-default" name="pdf_cand_generate_form_submit_templt_seventeen"
                       value="Generate PDF">
            </form>
            <script type="text/javascript">
                jQuery(document).on('click', '.jobsearch-get-cand-id-templt-seventeen', function () {
                    ...
                    request.done(function (response) {
                        if (typeof response.res !== 'undefined' && response.res == true) {
                            ...
                            //
                            jQuery("input[name=jobsearch_single_pdf_cand_id_templt_seventeen]").val(_cand_id);
                            jQuery("input[name=pdf_cand_generate_form_submit_templt_seventeen]").trigger('click')
                        }
                    });
        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_seventeen'])) {

                $candidate_id = $_POST['jobsearch_single_pdf_cand_id_templt_seventeen'];
                $stylesheet = file_get_contents($jobsearch_resume_export->jobsearch_resume_export_get_path('css/jobsearch-mpdf-style-template-seventeen.css'));
                ...
                ob_start();
                ?>
                <div class="pdf-style18-left-bar">
                    <?php if (!empty($profile_image)) { ?>
                        <div class="pdf-style18-thumb"
                             style="background-image: url('<?php echo($profile_image) ?>');"></div>
                    <?php } ?>
                    <div class="pdf-style18-left-bar-inner">
                        <!--Candidate Expertise-->
                ...
                <div class="pdf-style18-right-content">

                    <div class="pdf-style18-top-title-content">
                        <div class="pdf-style18-top-title">
                            <strong><?php echo($user_firstname) ?></strong><?php echo($user_last_name) ?></div>
                        <div class="pdf-style18-top-title-sub"><?php echo($candidate_address) ?></div>
                    </div>
                    ...
                    <div class="pdf-style18-right-content-inner">

                        <div class="pdf-style18-content-inn-title"><?php echo esc_html__('About Me', 'jobsearch-resume-export') ?></div>
                        <div class="pdf-style18-content-inn-pera"><?php echo($candidate_content) ?></div>
                        <div class="pdf-style18-content-border-line"></div>
                        <?php if (!empty($cand_email)) { ?>
                            <div class="pdf-style18-content-info">
                                <div class="pdf-style18-content-info-icon"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_18/envelope21.png') ?>"
                                            alt=""></div>
                                <div class="pdf-style18-content-info-text"><?php echo($cand_email) ?></div>
                            </div>
                        <?php } ?>
                        <?php if (!empty($phone_number)) { ?>
                            <div class="pdf-style18-content-info">
                                <div class="pdf-style18-content-info-icon"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_18/phone21.png') ?>"
                                            alt=""></div>
                                <div class="pdf-style18-content-info-text">+<?php echo($phone_number) ?></div>
                            </div>
                        <?php } ?>
                        <div class="pdf-style18-content-info">
                            <div class="pdf-style18-content-info-icon"><img
                                        src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_18/marker21.png') ?>"
                                        alt=""></div>
                            <div class="pdf-style18-content-info-text"><?php echo($candidate_address) ?></div>
                        </div>

                        <?php if (!empty($user_website)) { ?>
                            <div class="pdf-style18-section-heading">
                                <div class="pdf-style18-section-heading-text"><?php echo($user_website) ?></div>
                                <div class="pdf-style18-section-heading-line"></div>
                            </div>
                        <?php } ?>
                ...
                $mpdf->SetDefaultBodyCSS('background', "url('" . $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_18/barbg-color.png') . "')");
                $mpdf->SetDefaultBodyCSS('background-image-resize', 6);
                $mpdf->SetDefaultBodyCSS('width', '24%');
        ...
        public function jobsearch_candidate_resume_bulk_export_template_seventeen($candidate_id)
        {
        ...
        public static function jobsearch_resume_candidate_custom_fields($candidate_id)
        {
            ...
            if (!empty($custom_all_fields)) { ?>
                <div class="pdf-style18-bar-services">
                <?php
                $fields_data = [];
                foreach ($custom_all_fields as $info) {
                    ...
                    <?php } else if ($type == 'checkbox' && $field_for_non_reg_user != 'admin_view_only') {
                            ...
                            if (is_array($field_value) && count($field_value) > 0) { ?>
                                <div class="pdf-stylefield-bar-servicesfull-list">
                                    ...
                                    <div class="pdf-stylefield-bar-servicesfull-text">
                                        <div class="pdf-style18-bar-services-title"><?php echo($field_label) ?></div>
                                    </div>
                                    <?php
                        ...
                        <?php } else { ?>
                            ...
                            <div class="pdf-style18-bar-services-list">
                                <div class="pdf-style18-bar-icon">
                                    <div style="font-family: <?php echo($icon_type) ?>"><?php echo jobsearch_get_font_code($icon) ?></div>
                                </div>
                                <div class="pdf-style18-bar-services-text">
                                    <div class="pdf-style18-bar-services-title"><?php echo($info['label']) ?></div>
                                    <?php if (is_array($field_value) && count($field_value) > 0) {
                                        foreach ($field_value as $val) {  ?>
                                                <div class="pdf-style18-bar-services-sub"><?php echo($val) ?></div>
                                        ...
                                        ?>
                                        <div class="pdf-style18-bar-services-sub"><?php echo($field_value) ?></div>
                                    <?php } ?>
                ...
                if (count($fields_data) > 0) {
                    foreach ($fields_data as $fields) { ?>
                        <div class="pdf-style18-bar-services-list">
                            ...
                            <?php } ?>
                            <div class="pdf-style18-bar-services-text">
                                <div class="pdf-style18-bar-services-title"><?php echo($fields['label']) ?></div>
                                <div class="pdf-style18-bar-services-sub"><?php echo($fields['value']) ?></div>
                            </div>
                        </div>
                    <?php } ?>
                <?php } ?>
        ...
        public
        function jobsearch_resume_candidate_experience($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style18-bar-heading-main">
                    <div class="pdf-style18-bar-heading-icon">
                        <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_18/bag.png') ?>">
                    </div>
                    <div class="pdf-style18-bar-heading-text">
                        <div><?php echo esc_html__('EXPERIENCE', 'jobsearch-resume-export'); ?></div>
                    </div>
                </div>
                <div class="pdf-style18-content-list">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                    ...
                    foreach ($exfield_list as $key => $exfield) {
                        ...
                        ?>
                        <div class="pdf-style18-content-list-inner <?php echo ($x === $length) ? 'last' : '' ?>">
                            <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                <div class="pdf-style18-content-list-date"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?></div>
                            <?php } else { ?>
                                <div class="pdf-style18-content-list-date"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . ($experience_end_datefield_val != '' ? ' - ' . date('Y', strtotime($experience_end_datefield_val)) : '') ?></div>
                            <?php } ?>
                            <div class="pdf-style18-content-list-text">
                                <div class="pdf-style18-content-list-title"><?php echo jobsearch_esc_html($exfield) ?></div>
                                <div class="pdf-style18-content-list-sub"><?php echo jobsearch_esc_html($experience_end_companyfield_val) ?></div>
                                <div class="pdf-style18-content-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                            </div>
                        </div>
                        <?php
                        $exfield_counter++;
                        ...
                        <div class="pdf-style18-content-list-inner <?php echo ($x === $length) ? 'last' : '' ?>">
                            <?php if ($edu_start_metaexist) {
                                if ($education_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style18-content-list-date">
                                ...
                                <div class="pdf-style18-content-list-date"><?php echo($education_yearfield_val) ?></div>
                            <?php } ?>
                            <div class="pdf-style18-content-list-text">
                                <div class="pdf-style18-content-list-title"><?php echo jobsearch_esc_html($exfield) ?></div>
                                <div class="pdf-style18-content-list-sub"><?php echo($education_academyfield_val) ?></div>
                                <div class="pdf-style18-content-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                            </div>
                        </div>
        ...
        public
        static function jobsearch_resume_candidate_awards($candidate_id)
        {
            global $jobsearch_resume_export;
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style18-content-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style18-content-list-inner <?php echo ($x === $length) ? 'last' : '' ?>">
                            <div class="pdf-style18-content-list-date"><?php echo($award_yearfield_val) ?></div>
                            <div class="pdf-style18-content-list-text">
                                <div class="pdf-style18-content-list-title"><?php echo jobsearch_esc_html($exfield) ?></div>
                                <div class="pdf-style18-content-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                            </div>
        ...
        public
        static function jobsearch_resume_candidate_expertise($candidate_id)
        {
            global $jobsearch_resume_export;
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style18-bar-heading"><?php echo esc_html__('Expertise', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style18-skills-wrapper">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style18-skills">
                            <div class="pdf-style18-skills-left"><?php echo($exfield) ?></div>
                            <div class="pdf-style18-skills-line">
                                <div class="pdf-style18-skills-inn1"
                                     style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_18/skills-top16.png') ?>');"></div>
                                <div class="pdf-style18-skills-inn2"
                                     style="width: <?php echo($skill_percentagefield_val) ?>%;background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_18/skills-bg16.png') ?>');"></div>
                            </div>
                        </div>
                        <?php $exfield_counter++;
                        $x++;
        ...
        public
        static function jobsearch_resume_candidate_languages($candidate_id)
        {
            global $jobsearch_resume_export;
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style18-bar-heading"><?php echo esc_html__('Languages', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style18-skills-wrapper">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style18-skills">
                            <div class="pdf-style18-skills-left">
                                <strong><?php echo($exfield) ?></strong> <?php echo($lang_level_str) ?></div>
                            <div class="pdf-style18-skills-line">
                                <div class="pdf-style18-skills-inn1"
                                     style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_18/skills-top16.png') ?>');"></div>
                                <div class="pdf-style18-skills-inn2"
                                     style="width: <?php echo($lang_percentagefield_val) ?>%;background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_18/skills-bg16.png') ?>');"></div>
                            </div>
                        </div>
                        <?php
                        $exfield_counter++;
        ...
        public
        static function jobsearch_resume_cand_portfolio($candidate_id)
        {
            global $jobsearch_resume_export;
        ...
        public
        static function jobsearch_resume_candidate_skills($candidate_id)
        {
            ...
            if (!empty($skills_list)) { ?>
                <div class="pdf-style18-bar-heading"><?php echo esc_html__('Skills', 'jobsearch-resume-export') ?></div>
...
global $jobsearch_resume_pdf_template_seventeen;
$jobsearch_resume_pdf_template_seventeen = new jobsearch_candidate_pdf_resume_template_seventeen();