<?php
if (!class_exists('jobsearch_candidate_pdf_resume_template_fifteen')) {

    class jobsearch_candidate_pdf_resume_template_fifteen
    {
        ...
        public function jobsearch_single_candidate_resume_form()
        {
            ...
            ?>
            <form id="pdf_cand_generate_form_templt_fifteen" method="post" enctype="multipart/form-data"
                  style="display: none">
                <input type="text" name="jobsearch_single_pdf_cand_id_templt_fifteen" value="">
                <input type="submit" class="btn btn-default" name="pdf_cand_generate_form_submit_templt_fifteen"
                       value="Generate PDF">
            </form>
            <script type="text/javascript">
                jQuery(document).on('click', '.jobsearch-get-cand-id-templt-fifteen', function () {
                    ...
                    request.done(function (response) {
                        if (typeof response.res !== 'undefined' && response.res == true) {
                            ...
                            //
                            jQuery("input[name=jobsearch_single_pdf_cand_id_templt_fifteen]").val(_cand_id);
                            jQuery("input[name=pdf_cand_generate_form_submit_templt_fifteen]").trigger('click')
                        }
                    });
        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_fifteen'])) {

                $candidate_id = $_POST['jobsearch_single_pdf_cand_id_templt_fifteen'];
                $stylesheet = file_get_contents($jobsearch_resume_export->jobsearch_resume_export_get_path('css/jobsearch-mpdf-style-template-fifteen.css'));
                ...
                ob_start();
                ?>
                <div class="pdf-style16-body">
                    <div class="pdf-style16-left-bar">
                        <?php if (!empty($profile_image)) { ?>
                            <div class="pdf-style16-thumb">
                                <div style="background-image: url('<?php echo($profile_image) ?>');"></div>
                            </div>
                        <?php } ?>

                        <div class="pdf-style16-thumb-title"><?php echo($user_displayname) ?></div>
                        <div class="pdf-style16-thumb-sub"><?php echo($candidate_company_str) ?></div>
                        <!--Candidate Expertise-->
                        ...
                        if (!empty($candidate_social_mlinks) || ($cand_alow_fb_smm == 'on' || $cand_alow_twt_smm == 'on' || $cand_alow_gplus_smm == 'on' || $cand_alow_linkd_smm == 'on' || $cand_alow_dribbb_smm == 'on')) { ?>
                            <div class="pdf-style16-social-list">
                                <?php if ($user_facebook_url != '' && $cand_alow_fb_smm == 'on') { ?>
                                    <div class="pdf-style16-social-list-inn">
                                        <div class="pdf-style16-social-icon">
                                            <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_16/facebook.png') ?>">
                                        </div>
                                        <div class="pdf-style16-social-text">
                                            <div class="pdf-style16-social-title"><a
                                                        href="<?php echo jobsearch_esc_html(esc_url($user_facebook_url)) ?>"><?php echo jobsearch_esc_html(esc_url($user_facebook_url)) ?></a>
                                            </div>
                                            <div class="pdf-style16-social-sub"><?php echo esc_html__('Facebook', 'jobsearch-resume-export') ?></div>
                                        </div>
                                    </div>
                                <?php } ?>
                                <?php if ($user_twitter_url != '' && $cand_alow_twt_smm == 'on') { ?>
                                    <div class="pdf-style16-social-list-inn">
                                        <div class="pdf-style16-social-icon">
                                            <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_16/twitter.png') ?>">
                                        </div>
                                        <div class="pdf-style16-social-text">
                                            <div class="pdf-style16-social-title"><a
                                                        href="<?php echo jobsearch_esc_html(esc_url($user_linkedin_url)) ?>"><?php echo jobsearch_esc_html(esc_url($user_linkedin_url)) ?></a>
                                            </div>
                                            <div class="pdf-style16-social-sub"><?php echo esc_html__('LinkedIn Profile', 'jobsearch-resume-export') ?></div>
                                        </div>
                                    </div>
                                <?php } ?>
                                <?php if ($user_dribbble_url != '' && $cand_alow_dribbb_smm == 'on') { ?>
                                    <div class="pdf-style16-social-list-inn">
                                        <div class="pdf-style16-social-icon">
                                            <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_16/dribble.png') ?>">
                                        </div>
                                        <div class="pdf-style16-social-text">
                                            <div class="pdf-style16-social-title"><a
                                                        href="<?php echo jobsearch_esc_html(esc_url($user_dribbble_url)) ?>"><?php echo jobsearch_esc_html(esc_url($user_dribbble_url)) ?></a>
                                            </div>
                                            <div class="pdf-style16-social-sub"><?php echo esc_html__('Dribbble', 'jobsearch-resume-export') ?></div>
                                        </div>
                                    </div>
                                <?php } ?>
                                <?php if ($cand_email != '') { ?>
                                    <div class="pdf-style16-social-list-inn">
                                        <div class="pdf-style16-social-icon"><img
                                                    src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_16/atrate16.png') ?>"
                                                    alt=""></div>
                                        <div class="pdf-style16-social-text">
                                            <div class="pdf-style16-social-title"><?php echo jobsearch_esc_html(esc_url($cand_email)) ?></div>
                                            <div class="pdf-style16-social-sub"><?php echo esc_html__('Email', 'jobsearch-resume-export') ?></div>
                                        </div>
                                    </div>
                                <?php } ?>
                                <?php if ($phone_number != '') { ?>
                                    <div class="pdf-style16-social-list-inn">
                                        <div class="pdf-style16-social-icon"><img
                                                    src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_16/phone16.png') ?>">
                                        </div>
                                        <div class="pdf-style16-social-text">
                                            <div class="pdf-style16-social-title"><?php echo jobsearch_esc_html(esc_url($phone_number)) ?></div>
                                            <div class="pdf-style16-social-sub"><?php echo esc_html__('Phone', 'jobsearch-resume-export') ?></div>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
                    ...
                    <div class="pdf-style16-right-content">
        ...
        public function jobsearch_candidate_resume_bulk_export_template_fifteen($candidate_id)
        {
                    ...
                    if (!empty($candidate_social_mlinks) || ($cand_alow_fb_smm == 'on' || $cand_alow_twt_smm == 'on' || $cand_alow_gplus_smm == 'on' || $cand_alow_linkd_smm == 'on' || $cand_alow_dribbb_smm == 'on')) { ?>
                        <div class="pdf-style16-social-list">
                            ...
                            <?php if ($phone_number != '') { ?>
                                <div class="pdf-style16-social-list-inn">
                                    <div class="pdf-style16-social-icon">
                                    <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_16/phone16.png') ?>">
                                    </div>
                                    <div class="pdf-style16-social-text">
                                        <div class="pdf-style16-social-title"><?php echo jobsearch_esc_html(esc_url($phone_number)) ?></div>
                                        <div class="pdf-style16-social-sub"><?php echo esc_html__('Phone', 'jobsearch-resume-export') ?></div>
        ...
        public static function jobsearch_resume_candidate_custom_fields($candidate_id)
        {
            ...
            if (!empty($custom_all_fields)) { ?>
                <div class="pdf-style16-content-box">
                    <div class="pdf-style16-section-heading"><?php echo esc_html__('About Me', 'jobsearch-resume-export'); ?></div>
                    <div class="pdf-style16-bar-services">
                        <?php
                        $fields_data = array();
                        $lang_code = '';
                        if (function_exists('icl_object_id') && function_exists('wpml_init_language_switcher')) {
                     ...
                     <div class="pdf-style16-content-box">
                     <div class="pdf-style16-section-heading"><?php echo($field_label) ?></div>
                        <div class="pdf-style16-bar-services">
                        ...
                        <?php } else { ?>
                            <div class="pdf-style16-bar-services-list">
                                <div class="pdf-style16-bar-icon">
                                    <div style="font-family: <?php echo($icon_type) ?>"><?php echo jobsearch_get_font_code($icon) ?></div>
                                </div>
                                <div class="pdf-style16-bar-services-text">
                                    <div class="pdf-style16-bar-services-title"><?php echo($info['label']) ?></div>
                                    <?php if (is_array($field_value) && count($field_value) > 0) {
                                        foreach ($field_value as $val) { ?>
                                                <div class="pdf-style16-bar-services-sub"><?php echo($val) ?></div>
                                        <?php }
                                    } else {
                                        $field_value = $info['type'] == 'date' ? date_i18n($info['date-format'], $field_value) : $field_value;
                                        ?>
                                        <div class="pdf-style16-bar-services-sub"><?php echo($field_value) ?></div>
                                    <?php } ?>
                                </div>
                            </div>
                            <?php } ?>
                        ...
                        <div class="pdf-style16-bar-services-text">
                            <div class="pdf-style16-bar-services-title"><?php echo($fields['label']) ?></div>
                            <div class="pdf-style16-bar-services-sub"><?php echo($fields['value']) ?></div>
                        </div>
                    </div>
                         <?php } ?>
                         <?php } ?>
        ...
        public function jobsearch_resume_candidate_experience($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style16-content-box">
                    <div class="pdf-style16-section-heading"><?php echo esc_html__('Experience', 'jobsearch-resume-export'); ?></div>
                    <div class="pdf-style16-experience-list">
                        <?php
                        $exfield_counter = 0;
                        $x = 1;
                        ...
                        foreach ($exfield_list as $exfield) {
                            ...
                            ?>
                            <div class="pdf-style16-experience-list-inn">
                                <div class="pdf-style16-experience-list-circle">
                                    <div style=" background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_16/list-cricle16.png') ?>');"></div>
                                </div>
                                <div class="pdf-style16-experience-list-text">
                                    <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                        <div class="pdf-style16-experience-list-date"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?></div>
                                    <?php } else { ?>
                                        <div class="pdf-style16-experience-list-date"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . ($experience_end_datefield_val != '' ? ' - ' . date('Y', strtotime($experience_end_datefield_val)) : '') ?></div>
                                    <?php } ?>
                                    <div class="pdf-style16-experience-list-title"><?php echo jobsearch_esc_html($exfield) ?></div>
                                    <div class="pdf-style16-experience-list-sub"><?php echo jobsearch_esc_html($experience_end_companyfield_val) ?></div>
                                    <div class="pdf-style16-experience-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                                </div>
                            </div>
                            <?php
                            $exfield_counter++;
        ...
        public static function jobsearch_resume_candidate_education($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style16-content-box">
                    <div class="pdf-style16-section-heading">Education</div>
                    <div class="pdf-style16-experience-list">
                                ...
                                <div class="pdf-style16-experience-list-text">
                                    <?php if ($edu_start_metaexist) {
                                        if ($education_prsnt_datefield_val == 'on') { ?>
                                            <div class="pdf-style16-experience-list-date">
                                        ...
                                        <div class="pdf-style16-experience-list-date"><?php echo($education_yearfield_val) ?></div>
                                    <?php } ?>
                                    <div class="pdf-style16-experience-list-title"><?php echo($exfield) ?></div>
                                    <div class="pdf-style16-experience-list-sub"><?php echo($education_academyfield_val) ?></div>
                                    <div class="pdf-style16-experience-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                                </div>
                            </div>
        ...
        public static function jobsearch_resume_candidate_awards($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style16-content-box">
                    <div class="pdf-style16-section-heading"><?php echo esc_html__('Honors & Awards', 'jobsearch-resume-export'); ?></div>
                    <div class="pdf-style16-experience-list">
                        <?php
                        $exfield_counter = 0;
                        $x = 1;
                        foreach ($exfield_list as $exfield) {
                            ...
                            <div class="pdf-style16-experience-list-inn">
                                ...
                                <div class="pdf-style16-experience-list-text">
                                    <div class="pdf-style16-experience-list-date"><?php echo($award_yearfield_val) ?></div>
                                    <div class="pdf-style16-experience-list-title"><?php echo($exfield) ?></div>
                                    <div class="pdf-style16-experience-list-sub"><?php echo($exfield_val) ?></div>
                                </div>
                            </div>
                            <?php
                            $exfield_counter++;
        ...
        public static function jobsearch_resume_candidate_expertise($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style16-left-bar-heading"><?php echo esc_html__('Expertise', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style16-skills-wrapper">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style16-skills">
                            <div class="pdf-style16-skills-left"><?php echo($exfield) ?></div>
                            <div class="pdf-style16-skills-line">
                                <div class="pdf-style16-skills-inn1"
                                     style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_16/skills-top16.png') ?>')"></div>
                                <div class="pdf-style16-skills-inn2"
                                     style="width: <?php echo($skill_percentagefield_val) ?>%; background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_16/skills-bg16.png') ?>')"></div>
                            </div>
                        </div>
                        <?php $exfield_counter++;
                        $x++;
        ...
        public static function jobsearch_resume_candidate_languages($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style16-left-bar-heading"><?php echo esc_html__('Languages', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style16-skills-wrapper">
                    <?php
                    $exfield_counter = 0;
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style16-skills">
                            <div class="pdf-style16-skills-left">
                                <strong><?php echo($exfield) ?></strong> <?php echo($lang_level_str) ?></div>
                            <div class="pdf-style16-skills-line">
                                <div class="pdf-style16-skills-inn1"
                                     style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_16/skills-top16.png') ?>')"></div>
                                <div class="pdf-style16-skills-inn2"
                                     style="width: <?php echo($lang_percentagefield_val) ?>%; background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_16/skills-bg16.png') ?>')"></div>
                            </div>
                        </div>
        ...
        public static function jobsearch_resume_cand_portfolio($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style16-content-box">
                    <div class="pdf-style16-section-heading"><?php echo esc_html__('Portfolio', 'jobsearch-resume-export'); ?></div>
                    <div class="pdf-style16-experience-list">
                        <?php
                        $exfield_counter = 0;
                        foreach ($exfield_list as $exfield) {
        ...
        public static function jobsearch_resume_candidate_skills($candidate_id)
        {
            ...
            if (!empty($skills_list)) { ?>
                <div class="pdf-style16-left-bar-heading"><?php echo esc_html__('Skills', 'jobsearch-resume-export') ?></div>
...
global $jobsearch_resume_pdf_template_fifteen;
$jobsearch_resume_pdf_template_fifteen = new jobsearch_candidate_pdf_resume_template_fifteen();