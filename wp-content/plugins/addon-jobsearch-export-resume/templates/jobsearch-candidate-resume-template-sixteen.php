<?php
if (!class_exists('jobsearch_candidate_pdf_resume_template_sixteen')) {

    class jobsearch_candidate_pdf_resume_template_sixteen
    {
        ...
        public function jobsearch_single_candidate_resume_form()
        {
            ...
            ?>
            <form id="pdf_cand_generate_form_templt_sixteen" method="post" enctype="multipart/form-data"
                  style="display: none">
                <input type="text" name="jobsearch_single_pdf_cand_id_templt_sixteen" value="">
                <input type="submit" class="btn btn-default" name="pdf_cand_generate_form_submit_templt_sixteen"
                       value="Generate PDF">
            </form>
            <script type="text/javascript">
                jQuery(document).on('click', '.jobsearch-get-cand-id-templt-sixteen', function () {
                    ...
                    request.done(function (response) {
                        if (typeof response.res !== 'undefined' && response.res == true) {
                            ...
                            //
                            jQuery("input[name=jobsearch_single_pdf_cand_id_templt_sixteen]").val(_cand_id);
                            jQuery("input[name=pdf_cand_generate_form_submit_templt_sixteen]").trigger('click')
                        }
                    });
        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_sixteen'])) {

                $candidate_id = $_POST['jobsearch_single_pdf_cand_id_templt_sixteen'];
                $stylesheet = file_get_contents($jobsearch_resume_export->jobsearch_resume_export_get_path('css/jobsearch-mpdf-style-template-sixteen.css'));
                ...
                ob_start();
                ?>
                <div class="pdf-style17-left-bar">
                    <?php if (!empty($profile_image)) { ?>
                        <div class="pdf-style17-thumb">
                            <div style="background-image: url('<?php echo($profile_image) ?>');"></div>
                        </div>
                    <?php } ?>
                    <div class="pdf-style17-thumb-title"><?php echo($user_displayname) ?></div>
                    <div class="pdf-style17-thumb-sub"><?php echo($candidate_address) ?></div>
                    <div class="pdf-style17-bar-line">
                        <div></div>
                    </div>
                    <!--Candidate Custom Fields-->
                    <?php echo self::jobsearch_resume_candidate_custom_fields($candidate_id) ?>
                    <br>
                    <div class="pdf-style17-bar-heading-main">
                        <div class="pdf-style17-bar-heading-icon"><img
                                    src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_17/icon-user.png') ?>"
                                    alt=""></div>
                        <div class="pdf-style17-bar-heading-text">
                            <div><?php echo esc_html__('Executive Summary', 'jobsearch-resume-export') ?></div>
                        </div>
                    </div>
                    <div class="pdf-style17-bar-pera"><?php echo($candidate_content) ?></div>
                    <!--Candidate Expertise-->
                ...
                <div class="pdf-style17-right-content">
                    <?php if ($phone_number != '') { ?>
                        <div class="pdf-style17-content-info">
                            <div class="pdf-style17-content-info-icon">
                                <div>
                                    <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_17/icon-phone.png') ?>">
                                </div>
                            </div>
                            <div class="pdf-style17-content-info-text">+<?php echo($phone_number) ?></div>
                        </div>
                    <?php } ?>
                    <?php if ($cand_email != '') { ?>
                        <div class="pdf-style17-content-info">
                            <div class="pdf-style17-content-info-icon">
                                <div>
                                    <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_17/icon-envelope.png') ?>"
                                         alt=""></div>
                            </div>
                            <div class="pdf-style17-content-info-text"><?php echo($cand_email) ?></div>
                        </div>
                    <?php } ?>
                    <div class="pdf-style17-content-info last">
                        <div class="pdf-style17-content-info-icon">
                            <div>
                                <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_17/icon-marker.png') ?>"
                                     alt=""></div>
                        </div>
                        <div class="pdf-style17-content-info-text"><?php echo($candidate_address) ?></div>
                    </div>
        ...
        public function jobsearch_candidate_resume_bulk_export_template_sixteen($candidate_id)
        {
            ...
            <div class="pdf-style17-right-content">
                ...
                <?php if ($cand_email != '') { ?>
                    <div class="pdf-style17-content-info">
                        ...
                        <div class="pdf-style17-content-info-text"><?php echo jobsearch_esc_html(esc_url($cand_email)) ?></div>
                    </div>
                <?php } ?>
                <div class="pdf-style17-content-info last">
                    <div class="pdf-style17-content-info-icon">
        ...
        public static function jobsearch_resume_candidate_custom_fields($candidate_id)
        {
            ...
            if (!empty($custom_all_fields)) { ?>
                <div class="pdf-style17-bar-services">
                <?php
                $fields_data = [];
                foreach ($custom_all_fields as $info) {
                    ...
                    <?php } else if ($type == 'checkbox' && $field_for_non_reg_user != 'admin_view_only') {
                        ...
                        if ($type == 'upload_file' && $field_for_non_reg_user != 'admin_view_only') {
                            if (is_array($field_value) && count($field_value) > 0) { ?>
                                <div class="pdf-stylefield-bar-servicesfull-list">
                                    <?php if (!empty($icon)) { ?>
                                        <div class="pdf-style17-bar-icon">
                                    ...
                                    <div class="pdf-stylefield-bar-servicesfull-text">
                                        <div class="pdf-style17-bar-services-title"><?php echo($field_label) ?></div>
                                    </div>
                                    <?php
                        ...
                        <?php } else { ?>
                            <div class="pdf-style17-bar-services-list">
                                <div class="pdf-style17-bar-icon">
                                    <div style="font-family: <?php echo($icon_type) ?>"><?php echo jobsearch_get_font_code($icon) ?></div>
                                </div>
                                <div class="pdf-style17-bar-services-text">
                                    <div class="pdf-style17-bar-services-title"><?php echo($field_label) ?></div>
                                    <?php if (is_array($field_value) && count($field_value) > 0) {
                                        foreach ($field_value as $val) { ?>
                                            <div class="pdf-style17-bar-services-sub"><?php echo($val) ?></div>
                                        <?php }
                                    } else {
                                        $field_value = $type == 'date' ? date_i18n($info['date-format'], $field_value) : $field_value;

                                        ?>
                                        <div class="pdf-style17-bar-services-sub"><?php echo($field_value) ?></div>
                                    <?php } ?>
                                </div>
                            </div>
                        <?php } ?>
                ...
                if (count($fields_data) > 0) {
                    foreach ($fields_data as $fields) { ?>
                        <div class="pdf-style17-bar-services-list">
                            ...
                            <?php } ?>
                            <div class="pdf-style17-bar-services-text">
                                <div class="pdf-style17-bar-services-title"><?php echo($fields['label']) ?></div>
                                <div class="pdf-style17-bar-services-sub"><?php echo($fields['value']) ?></div>
                            </div>
                        </div>
                    <?php } ?>
                <?php } ?>
        ...
        public function jobsearch_resume_candidate_experience($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style17-bar-heading-main">
                    <div class="pdf-style17-bar-heading-icon">
                        <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_17/icon-tie.png') ?>">
                    </div>
                    <div class="pdf-style17-bar-heading-text">
                        <div><?php echo esc_html__('Experience', 'jobsearch-resume-export'); ?></div>
                    </div>
                </div>
                <div class="pdf-style17-content-list">
                    ...
                    foreach ($exfield_list as $key => $exfield) {
                        ...
                        ?>
                        <div class="pdf-style17-content-list-inner <?php echo ($key == 0) ? 'first' : '' ?> <?php echo ($x === $length) ? 'last' : '' ?>">
                            <div class="pdf-style17-content-list-circle"
                                 style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_17/circle20.png') ?>');">
                                <div></div>
                            </div>
                            <div class="pdf-style17-content-list-date">
                                <div class="pdf-style17-content-list-date-title"><?php echo jobsearch_esc_html($exfield) ?></div>
                                <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style17-content-list-date-sub"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?></div>
                                <?php } else { ?>
                                    <div class="pdf-style17-content-list-date-sub"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . ($experience_end_datefield_val != '' ? ' - ' . date('Y', strtotime($experience_end_datefield_val)) : '') ?></div>
                                <?php } ?>

                            </div>
                            <div class="pdf-style17-content-list-text">
                                <div class="pdf-style17-content-list-title"><?php echo jobsearch_esc_html($experience_end_companyfield_val) ?></div>
                                <div class="pdf-style17-content-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                            </div>
                        </div>
        ...
        public static function jobsearch_resume_candidate_education($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style17-bar-heading-main">
                    <div class="pdf-style17-bar-heading-icon"><img
                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_17/icon-bin.png') ?>"
                                alt=""></div>
                    <div class="pdf-style17-bar-heading-text">
                        <div>education</div>
                    </div>
                ...
                <div class="pdf-style17-content-list">
                    ...
                    foreach ($exfield_list as $key => $exfield) {
                        ...
                        <div class="pdf-style17-content-list-inner <?php echo ($key == 0) ? 'first' : '' ?> <?php echo ($x === $length) ? 'last' : '' ?>">
                            ...
                            <div class="pdf-style17-content-list-date">
                                <div class="pdf-style17-content-list-date-title"><?php echo($exfield) ?></div>
                                <?php if ($edu_start_metaexist) {
                                    if ($education_prsnt_datefield_val == 'on') { ?>
                                        <div class="pdf-style17-content-list-date-min">
                            ...
                            <div class="pdf-style17-content-list-text">
                                <div class="pdf-style17-content-list-title"><?php echo($education_academyfield_val) ?></div>
                                <div class="pdf-style17-content-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                            </div>
                        </div>
                        <?php $exfield_counter++;
        ...
        public static function jobsearch_resume_candidate_awards($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style17-bar-heading-main">
                    <div class="pdf-style17-bar-heading-icon"><img
                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_17/icon-label.png') ?>"
                                alt=""></div>
                    <div class="pdf-style17-bar-heading-text">
                ...
                <div class="pdf-style17-content-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style17-content-list-inner first">
                            <div class="pdf-style17-content-list-circle"
                                 style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_17/circle20.png') ?>');">
                                <div></div>
                            </div>
                            <div class="pdf-style17-content-list-date">
                                ...
                                <div class="pdf-style17-content-list-date-sub"><?php echo($award_yearfield_val) ?></div>
                            </div>
                            <div class="pdf-style17-content-list-text">
                                <div class="pdf-style17-content-list-title"><?php echo($exfield) ?></div>
                                <div class="pdf-style17-content-list-pera"><?php echo($exfield_val) ?></div>
                            </div>
                        </div>
        ...
        public static function jobsearch_resume_candidate_expertise($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style17-bar-heading-main">
                    <div class="pdf-style17-bar-heading-icon"><img
                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_17/icon-mouse.png') ?>"
                                alt=""></div>
                    <div class="pdf-style17-bar-heading-text">
                        <div><?php echo esc_html__('Expertise', 'jobsearch-resume-export') ?></div>
                    </div>
                </div>
                <div class="pdf-style17-skills-wrap">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style17-skills">
                            <div class="pdf-style17-skills-left"><?php echo($exfield) ?></div>
                            <div class="pdf-style17-skills-line">
                                <div class="pdf-style17-skills-inn1"></div>
                                <div class="pdf-style17-skills-inn2"
        ...
        public static function jobsearch_resume_candidate_languages($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style17-bar-heading-main">
                    <div class="pdf-style17-bar-heading-icon"><img
                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_17/icon-shape.png') ?>"
                                alt=""></div>
                    <div class="pdf-style17-bar-heading-text">
                        <div><?php echo esc_html__('Languages', 'jobsearch-resume-export') ?></div>
                    </div>
                </div>
                <div class="pdf-style17-skills-wrap">
                    <?php
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style17-skills">
                            <div class="pdf-style17-skills-left">
...
global $jobsearch_resume_pdf_template_sixteen;
$jobsearch_resume_pdf_template_sixteen = new jobsearch_candidate_pdf_resume_template_sixteen();