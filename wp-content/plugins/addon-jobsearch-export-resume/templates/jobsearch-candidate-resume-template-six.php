<?php
if (!class_exists('jobsearch_candidate_pdf_resume_template_six')) {

    class jobsearch_candidate_pdf_resume_template_six
    {
        ...
        public function jobsearch_single_candidate_resume_form()
        {
            ...
            ?>
            <form id="pdf_cand_generate_form_templt_six" method="post" enctype="multipart/form-data"
                  style="display: none">
                <input type="text" name="jobsearch_single_pdf_cand_id_templt_six" value="">
                <input type="submit" class="btn btn-default" name="pdf_cand_generate_form_submit_templt_six"
                       value="Generate PDF">
            </form>
            <script type="text/javascript">
                jQuery(document).on('click', '.jobsearch-get-cand-id-templt-six', function () {
                    ...
                    request.done(function (response) {
                        if (typeof response.res !== 'undefined' && response.res == true) {
                            ...
                            //
                            jQuery("input[name=jobsearch_single_pdf_cand_id_templt_six]").val(_cand_id);
                            jQuery("input[name=pdf_cand_generate_form_submit_templt_six]").trigger('click')
                        }
                    });
        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_six'])) {

                $candidate_id = $_POST['jobsearch_single_pdf_cand_id_templt_six'];
                $stylesheet = file_get_contents($jobsearch_resume_export->jobsearch_resume_export_get_path('css/jobsearch-mpdf-style-template-six.css'));
                ...
                <div class="pdf-style8-body">
                    <div class="pdf-style8-left-content">
                        <div class="pdf-style8-content-title"><?php echo($user_firstname) ?>
                            <span><?php echo($user_last_name) ?></span></div>
                        <?php if (!empty($candidate_company_str)) { ?>
                            <div class="pdf-style8-content-title-sub"><?php echo($candidate_company_str) ?></div>
                        <?php } ?>
                    ...
                    <div class="pdf-style8-right-bar">
                        <?php if (!empty($profile_image)) { ?>
                            <div class="pdf-style8-right-thumb">
                                <div style="background-image: url('<?php echo $profile_image ?>');"></div>
                            </div>
                        <?php } ?>
                        <?php if (!empty($candidate_content)) { ?>
                            <div class="pdf-style8-bar-title">
                                <div class="pdf-style8-bar-title-text"><?php echo esc_html__('Objective', 'jobsearch-resume-export') ?></div>
                                <div class="pdf-style8-bar-title-line"></div>
                                <div class="pdf-style8-bar-title-line inner"></div>
                                <div class="pdf-style8-bar-title-line"></div>
                            </div>
                            <div class="pdf-style8-bar-pera"><?php echo($candidate_content) ?></div>
                        <?php } ?>

                        <div class="pdf-style8-bar-border"></div>
                        <div class="pdf-style8-bar-title">
                            <div class="pdf-style8-bar-title-text"><?php echo esc_html__('Contact Me', 'jobsearch-resume-export') ?></div>
                            <div class="pdf-style8-bar-title-line"></div>
                            <div class="pdf-style8-bar-title-line inner"></div>
                            <div class="pdf-style8-bar-title-line"></div>
                        </div>

                        <div class="pdf-style8-bar-list-wrap">
                            <?php if (!empty($phone_number)) { ?>
                                <div class="pdf-style8-bar-list-inn">
                                    <div class="pdf-style8-bar-list-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/phone.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style8-bar-list-text">+<?php echo($phone_number) ?></div>
                                </div>
                            <?php } ?>
                            <?php if (!empty($cand_email)) { ?>
                                <div class="pdf-style8-bar-list-inn">
                                    <div class="pdf-style8-bar-list-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/envelope.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style8-bar-list-text"><?php echo($cand_email) ?></div>
                                </div>
                            <?php } ?>
                            <?php if (!empty($user_website)) { ?>
                                <div class="pdf-style8-bar-list-inn">
                                    <div class="pdf-style8-bar-list-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/world.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style8-bar-list-text"><?php echo($user_website) ?></div>
                                </div>
                            <?php } ?>
                            <?php if (!empty($candidate_address)) { ?>
                                <div class="pdf-style8-bar-list-inn">
                                    <div class="pdf-style8-bar-list-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/marker.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style8-bar-list-text"><?php echo($candidate_address) ?></div>
                                </div>
                            <?php } ?>
                        </div>
                        <div class="pdf-style8-bar-border"></div>
                        ...
                        ?>
                        <div class="pdf-style8-bar-title">
                            <div class="pdf-style8-bar-title-text"><?php echo esc_html__('Follow Me', 'jobsearch-resume-export') ?></div>
                            <div class="pdf-style8-bar-title-line"></div>
                            <div class="pdf-style8-bar-title-line inner"></div>
                            <div class="pdf-style8-bar-title-line"></div>
                        </div>
                        ...
                        <div class="pdf-style8-bar-list-wrap">
                            <?php if ($user_facebook_url != '' && $cand_alow_fb_smm == 'on') { ?>
                                <div class="pdf-style8-bar-list-inn">
                                    <div class="pdf-style8-bar-list-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/facebook.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style8-bar-list-text"><a
                            ...
                            <?php if ($user_twitter_url != '' && $cand_alow_twt_smm == 'on') { ?>
                                <div class="pdf-style8-bar-list-inn">
                                    <div class="pdf-style8-bar-list-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/twitter.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style8-bar-list-text">
                            ...
                            <?php if ($user_linkedin_url != '' && $cand_alow_linkd_smm == 'on') { ?>
                                <div class="pdf-style8-bar-list-inn">
                                    <div class="pdf-style8-bar-list-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/linkedin.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style8-bar-list-text">
                            ...
                            <?php if ($user_dribbble_url != '' && $cand_alow_dribbb_smm == 'on') { ?>
                                <div class="pdf-style8-bar-list-inn">
                                    <div class="pdf-style8-bar-list-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/dribble.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style8-bar-list-text">
                            ...
                            <?php if ($user_youtube_url != '') { ?>
                                <div class="pdf-style8-bar-list-inn">
                                    <div class="pdf-style8-bar-list-icon">
                                        <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/youtube.png') ?>">
                                    </div>
                                    <div class="pdf-style8-bar-list-text">
        ...
        public function jobsearch_candidate_resume_bulk_export_template_six($candidate_id)
        {
        ...
        public static function jobsearch_resume_candidate_custom_fields($candidate_id)
        {
            ...
            if (!empty($custom_all_fields)) { ?>
                <div class="pdf-style8-section-heading">
                    <div class="pdf-style8-section-heading-icon">
                        <div style="font-family: jobsearch">&#xe92f</div>
                    </div>
                    <div class="pdf-style8-section-heading-text"><?php echo esc_html__('About Me', 'jobsearch-resume-export'); ?></div>
                </div>
                ...
                foreach ($custom_all_fields as $info) {
                    ...
                    if ($type == 'heading' && $field_for_non_reg_user != 'admin_view_only') { ?>
                        ...
                        <div class="pdf-style8-section-heading">
                            ...
                            <div class="pdf-style8-section-heading-text"><?php echo($field_label) ?></div>
                        </div>
        ...
        public function jobsearch_resume_candidate_experience($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style8-section-heading">
                    ...
                    <div class="pdf-style8-section-heading-text"><?php echo esc_html__('Job Experiences', 'jobsearch-resume-export'); ?></div>
                </div>
                <div class="pdf-style8-content-list">
                    <?php
                    $exfield_counter = 0;
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style8-content-list-inn">
                            <div class="pdf-style8-content-list-title">
                                <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/content-arrow.png') ?>"
                                     alt=""> <?php echo jobsearch_esc_html($exfield) ?> &nbsp;

                                <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                    <span><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?></span>
                                <?php } else { ?>
                                    <span><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . ($experience_end_datefield_val != '' ? ' - ' . date('Y', strtotime($experience_end_datefield_val)) : '') ?></span>
                                <?php } ?>
                            </div>
                            <div class="pdf-style8-content-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                        </div>
        ...
        public static function jobsearch_resume_candidate_education($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style8-section-heading">
                    ...
                    <div class="pdf-style8-section-heading-text"><?php echo esc_html__('Education', 'jobsearch-resume-export'); ?></div>
                </div>
                ...
                <div class="pdf-style8-content-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style8-content-list-inn">
                            <div class="pdf-style8-content-list-title">
                                <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/content-arrow.png') ?>"
                                     alt=""> <?php echo($exfield) ?> &nbsp;

                                <?php
                                if ($edu_start_metaexist) {
                                    if ($education_prsnt_datefield_val == 'on') { ?>
                                        <span><?php echo ($education_start_datefield_val != '' ? date('Y', strtotime($education_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'wp-jobsearch') ?></span>
                                    <?php } else { ?>
                                        <span><?php echo ($education_start_datefield_val != '' ? date('Y', strtotime($education_start_datefield_val)) : '') . ($education_end_datefield_val != '' ? ' - ' . date('Y', strtotime($education_end_datefield_val)) : '') ?></span>
                                        <?php
                                    }
                                } else { ?>
                                    <span><?php echo($education_yearfield_val) ?></span>
                                <?php } ?>
                            </div>
                            <div class="pdf-style8-content-list-pera"><?php echo($exfield_val) ?></div>
                        </div>
                        <?php $exfield_counter++;
                        $x++;
                    } ?>
        ...
        public static function jobsearch_resume_candidate_awards($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style8-section-heading">
                    ...
                    <div class="pdf-style8-section-heading-text"><?php echo esc_html__('Honors & Awards', 'jobsearch-resume-export'); ?></div>
                </div>
                <div class="pdf-style8-content-list">
                    <?php
                    $exfield_counter = 0;
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style8-content-list-inn">
                            <div class="pdf-style8-content-list-title">
                                <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/content-arrow.png') ?>"> <?php echo jobsearch_esc_html($exfield) ?>
                                &nbsp;
                                <span><?php echo jobsearch_esc_html($award_yearfield_val) ?></span>
                            </div>
                            <div class="pdf-style8-content-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                        </div>
                        <?php $exfield_counter++;
        ...
        public static function jobsearch_resume_candidate_expertise($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style8-content-col1">
                    <div class="pdf-style8-section-heading">
                        <div class="pdf-style8-section-heading-icon">
                            <div style="font-family: jobsearch">&#xe92f</div>
                        </div>
                        <div class="pdf-style8-section-heading-text"><?php echo esc_html__('EXPERTISE', 'jobsearch-resume-export') ?></div>
                    </div>
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style8-skills">
                            <div class="pdf-style8-skills-left"><?php echo($exfield) ?></div>
                            <div class="pdf-style8-skills-line">
                                <div class="pdf-style8-skills-inn1"></div>
                                <div class="pdf-style8-skills-inn2"
                                     style="width: <?php echo($skill_percentagefield_val) ?>%; background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/skills-bg.png') ?>');"></div>
                            </div>
                        </div>
                        <?php $exfield_counter++;
                        $x++;
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style8-content-col1">
                    <div class="pdf-style8-section-heading">
                        ...
                        <div class="pdf-style8-section-heading-text"><?php echo esc_html__('Languages', 'jobsearch-resume-export') ?></div>
                    </div>
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style8-skills">
                            <div class="pdf-style8-skills-left">
                                <strong><?php echo($exfield) ?></strong> <?php echo($lang_level_str) ?></div>
                            <div class="pdf-style8-skills-line">
                                <div class="pdf-style8-skills-inn1"></div>
                                <div class="pdf-style8-skills-inn2"
                                     style="width: <?php echo($lang_percentagefield_val) ?>%; background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_7/skills-top.png') ?>');"></div>
                            </div>
                        </div>
                        <?php
                        $exfield_counter++;
        ...
        public static function jobsearch_resume_cand_portfolio($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style8-section-heading">
                    ...
                    <div class="pdf-style8-section-heading-text"><?php echo esc_html__('Portfolio', 'jobsearch-resume-export') ?></div>
                </div>
                <div class="pdf-style8-content-list">
                    <?php
                    $exfield_counter = 0;
        ...
        public static function jobsearch_resume_candidate_skills($candidate_id)
        {
            ...
            if (!empty($skills_list)) { ?>
                ...
                <div class="pdf-style8-bar-title">
                    <div class="pdf-style8-bar-title-text"><?php echo esc_html__('Skills', 'jobsearch-resume-export') ?></div>
                    <div class="pdf-style8-bar-title-line"></div>
                    <div class="pdf-style8-bar-title-line inner"></div>
                    <div class="pdf-style8-bar-title-line"></div>
                </div>
...
global $jobsearch_resume_pdf_template_six;
$jobsearch_resume_pdf_template_six = new jobsearch_candidate_pdf_resume_template_six();