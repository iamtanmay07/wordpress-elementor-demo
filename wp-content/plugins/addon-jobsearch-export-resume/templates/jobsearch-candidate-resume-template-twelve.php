                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style13-experience-list-inn">
                            <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                <div class="pdf-style13-experience-list-date"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?></div>
                            <?php } else { ?>
                                <div class="pdf-style13-experience-list-date"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . ($experience_end_datefield_val != '' ? ' - ' . date('Y', strtotime($experience_end_datefield_val)) : '') ?></div>
                            <?php } ?>
