<?php
if (!class_exists('jobsearch_candidate_pdf_resume_template_eleven')) {

    class jobsearch_candidate_pdf_resume_template_eleven
    {
        public function __construct()
        {
            add_action('init', array($this, 'jobsearch_single_candidate_resume_export_callback'));
            //add_action('admin_init', array($this, 'jobsearch_single_candidate_resume_export_callback'), 1000);
        ...
        public function jobsearch_single_candidate_resume_form()
        {
            ...
            ?>
            <form id="pdf_cand_generate_form_templt_eleven" method="post" enctype="multipart/form-data"
                  style="display: none">
                <input type="text" name="jobsearch_single_pdf_cand_id_templt_eleven" value="">
                <input type="submit" class="btn btn-default" name="pdf_cand_generate_form_submit_templt_eleven"
                       value="Generate PDF">
            </form>
            <script type="text/javascript">
                jQuery(document).on('click', '.jobsearch-get-cand-id-templt-eleven', function () {
                    ...
                    request.done(function (response) {
                        if (typeof response.res !== 'undefined' && response.res == true) {
                            ...
                            //
                            jQuery("input[name=jobsearch_single_pdf_cand_id_templt_eleven]").val(_cand_id);
                            jQuery("input[name=pdf_cand_generate_form_submit_templt_eleven]").trigger('click')
                        }
                    });
        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_eleven'])) {

                $candidate_id = $_POST['jobsearch_single_pdf_cand_id_templt_eleven'];

                $stylesheet = file_get_contents($jobsearch_resume_export->jobsearch_resume_export_get_path('css/jobsearch-mpdf-style-template-eleven.css'));
                ...
                ob_start();
                ?>
                <div class="pdf-style12-left-bar"
                     style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_12/bg_1.png') ?>');">
                    <?php if (!empty($profile_image)) { ?>
                        <div class="pdf-style12-bar-thumb">
                            <div style="background-image: url('<?php echo($profile_image) ?>');"></div>
                        </div>
                    <?php } ?>
                    <div class="pdf-style12-bar-text-section"
                         style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_12/red.png') ?>');">
                        <div class="pdf-style12-bar-text-title"><?php echo($user_displayname) ?></div>
                        <div class="pdf-style12-bar-text-sub"><?php echo($candidate_company_str) ?></div>

                        <div class="pdf-style12-social-list">

                            <div class="pdf-style12-social-list-inn">
                                <div class="pdf-style12-social-icon">
                                    <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_12/location.png') ?>">
                                </div>
                                <div class="pdf-style12-social-text">
                                    <div class="pdf-style12-social-title"><?php echo esc_html__('Address:', 'jobsearch-resume-export') ?></div>
                                    <div class="pdf-style12-social-sub"><?php echo($candidate_address) ?></div>
                                </div>
                            </div>
                            <div class="pdf-style12-social-list-inn">
                                <div class="pdf-style12-social-icon"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_12/call.png') ?>"
                                            alt=""></div>
                                <div class="pdf-style12-social-text">
                                    <div class="pdf-style12-social-title"><?php echo esc_html__('Phone:', 'jobsearch-resume-export') ?></div>
                                    <div class="pdf-style12-social-sub"><?php echo($phone_number) ?></div>
                                </div>
                            </div>
                            <div class="pdf-style12-social-list-inn">
                                <div class="pdf-style12-social-icon"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_12/envelope.png') ?>"
                                            alt=""></div>
                                <div class="pdf-style12-social-text">
                                    <div class="pdf-style12-social-title"><?php echo esc_html__('Email:', 'jobsearch-resume-export') ?></div>
                                    <div class="pdf-style12-social-sub"><?php echo($cand_email) ?></div>
                                </div>
                            </div>
                            <div class="pdf-style12-social-list-inn">
                                <div class="pdf-style12-social-icon"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_12/world.png') ?>"
                                            alt=""></div>
                                <div class="pdf-style12-social-text">
                                    <div class="pdf-style12-social-title"><?php echo esc_html__('Website:', 'jobsearch-resume-export') ?></div>
                                    <div class="pdf-style12-social-sub"><?php echo($user_website) ?></div>
                                </div>
                            </div>
                            <div class="pdf-style12-social-list-inn">
                                <div class="pdf-style12-social-icon">
                                    <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_12/cake.png') ?>">
                                </div>
                                <div class="pdf-style12-social-text">
                                    <div class="pdf-style12-social-title"><?php echo esc_html__('DOB:', 'jobsearch-resume-export') ?></div>
                                    <div class="pdf-style12-social-sub"><?php echo($user_dob_whole) ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pdf-style12-right-content">
                    <?php if (!empty(cand_calculate_experience($candidate_id))) { ?>
                        <div class="pdf-style12-content-title">
                            <span><?php echo cand_calculate_experience($candidate_id); ?></span><?php echo esc_html__(' of Experience', 'jobsearch-resume-export') ?>
                        </div>
                    <?php } ?>
                    <div class="pdf-style12-content-pera"><?php echo($candidate_content) ?></div>
        ...
        public function jobsearch_candidate_resume_bulk_export_template_eleven($candidate_id)
        {
        ...
        public static function jobsearch_resume_candidate_custom_fields($candidate_id)
        {
            ...
            if (!empty($custom_all_fields)) { ?>
                <div class="pdf-style12-section-heading"><?php echo esc_html__('About Me', 'jobsearch-resume-export'); ?></div>
                <div class="pdf-style12-bar-services">
                <?php
                $fields_data = array();
                $lang_code = '';
                if (function_exists('icl_object_id') && function_exists('wpml_init_language_switcher')) {
                ...
                foreach ($custom_all_fields as $info) {
                    ...
                    if ($type == 'heading' && $field_for_non_reg_user != 'admin_view_only') { ?>
                        ...
                        <div class="pdf-style12-section-heading"><?php echo($field_label) ?></div>
                        <div class="pdf-style12-bar-services">
                    ...
                    <?php } else if ($type == 'checkbox' && $field_for_non_reg_user != 'admin_view_only') {
                            ...
                            if (is_array($field_value) && count($field_value) > 0) { ?>
                                ...
                                <div class="pdf-stylefield-bar-servicesfull-list">
                                    ...
                                    <div class="pdf-stylefield-bar-servicesfull-text">
                                        <div class="pdf-style12-bar-services-title"><?php echo($field_label) ?></div>
                        ...
                        <?php } else { ?>
                            <div class="pdf-style12-bar-services-list">
                                <div class="pdf-style12-bar-icon">
                                    <div style="font-family: <?php echo($icon_type) ?>"><?php echo jobsearch_get_font_code($icon) ?></div>
                                </div>
                                <div class="pdf-style12-bar-services-text">
                                    <div class="pdf-style12-bar-services-title"><?php echo($field_label) ?></div>
                                    <?php if (is_array($field_value) && count($field_value) > 0) {
                                        foreach ($field_value as $val) {
                                            if ($info['type'] == 'upload_file') {
                                                $img_path = str_replace(get_site_url(), ABSPATH, $val);
                                                ?>
                                                <div class="pdf-style12-bar-services-sub">
                                                    <img src="<?php echo($img_path) ?>"></div>
                                            <?php } else { ?>
                                                <div class="pdf-style12-bar-services-sub"><?php echo($val) ?></div>
                                            <?php } ?>
                                        <?php }
                                    } else {
                                        $field_value = $info['type'] == 'date' ? date_i18n($info['date-format'], $field_value) : $field_value;
                                        ?>
                                        <div class="pdf-style12-bar-services-sub"><?php echo($field_value) ?></div>
                                    <?php } ?>
                                </div>
                            </div>
                        <?php } ?>
                ...
                if (count($fields_data) > 0) {
                    foreach ($fields_data as $fields) { ?>
                        <div class="pdf-style12-bar-services-list">
                            ...
                            <?php } ?>
                            <div class="pdf-style12-bar-services-text">
                                <div class="pdf-style12-bar-services-title"><?php echo($fields['label']) ?></div>
                                <div class="pdf-style12-bar-services-sub"><?php echo($fields['value']) ?></div>
                            </div>
                        </div>
                    <?php } ?>
                <?php } ?>
        ...
        public function jobsearch_resume_candidate_experience($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style12-section-heading"><?php echo esc_html__('Experience', 'jobsearch-resume-export'); ?></div>
                <div class="pdf-style12-timeline-wrapper">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style12-timeline-inner">
                            <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                <div class="pdf-style12-timeline-year"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?></div>
                            <?php } else { ?>
                                <div class="pdf-style12-timeline-year"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . ($experience_end_datefield_val != '' ? ' - ' . date('Y', strtotime($experience_end_datefield_val)) : '') ?></div>
                            <?php } ?>
                            <div class="pdf-style12-timeline-text">
                                <div class="pdf-style12-timeline-circle">
                                    <img src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_12/cic.png') ?>">
                                </div>
                                <div class="pdf-style12-timeline-title"><?php echo jobsearch_esc_html($exfield) ?></div>
                                <div class="pdf-style12-timeline-sub"><?php echo jobsearch_esc_html($experience_end_companyfield_val) ?></div>
                                <div class="pdf-style12-timeline-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                            </div>
                        </div>
        ...
        public static function jobsearch_resume_candidate_education($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style12-section-heading"><?php echo esc_html__('Education', 'jobsearch-resume-export'); ?></div>
                <div class="pdf-style12-timeline-wrapper">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                        ...
                        <div class="pdf-style12-timeline-inner">
                            ...
                            if ($edu_start_metaexist) {
                                if ($education_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style12-timeline-year">
                                ...
                                <div class="pdf-style12-timeline-year"><?php echo($education_yearfield_val) ?></div>
                            <?php } ?>
                            <div class="pdf-style12-timeline-text">
                                <div class="pdf-style12-timeline-circle"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_12/cic.png') ?>"
                                            alt=""></div>
                                <div class="pdf-style12-timeline-title"><?php echo($exfield) ?></div>
                                <div class="pdf-style12-timeline-sub"><?php echo($exfield_val) ?></div>
                            </div>
                        </div>
                        <?php $exfield_counter++;
                        $x++;
        ...
        public static function jobsearch_resume_candidate_awards($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style12-section-heading"><?php echo esc_html__('Honors & Awards', 'jobsearch-resume-export'); ?></div>
                <div class="pdf-style12-timeline-wrapper">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style12-timeline-inner <?php echo ($x == $length) ? 'last' : '' ?>">
                            <div class="pdf-style12-timeline-year"><?php echo jobsearch_esc_html($award_yearfield_val) ?></div>
                            <div class="pdf-style12-timeline-text">
                                <div class="pdf-style12-timeline-circle"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_12/cic.png') ?>"
                                            alt=""></div>
        ...
        public static function jobsearch_resume_candidate_expertise($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style12-bar-bottom">
                    <div class="pdf-style12-bar-bottom-title"><?php echo esc_html__('Expertise', 'jobsearch-resume-export') ?></div>
                    <div class="pdf-style12-skills-wrap">
                        <?php
                        $exfield_counter = 0;
                        $x = 1;
                        foreach ($exfield_list as $exfield) {
                            ...
                            ?>
                            <div class="pdf-style12-skills">
                                <div class="pdf-style12-skills-left"><?php echo($exfield) ?></div>
                                <div class="pdf-style12-skills-line">
                                    <div class="pdf-style12-skills-inn1"></div>
                                    <div class="pdf-style12-skills-inn2"
        ...
        public static function jobsearch_resume_candidate_languages($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style12-bar-bottom">
                    <div class="pdf-style12-bar-bottom-title"><?php echo esc_html__('Languages', 'jobsearch-resume-export') ?></div>
                    <div class="pdf-style12-skills-wrap">
                        <?php
                        $exfield_counter = 0;
                        foreach ($exfield_list as $exfield) {
                            ...
                            ?>
                            <div class="pdf-style12-skills">
                                <div class="pdf-style12-skills-left">
        ...
        public static function jobsearch_resume_candidate_skills($candidate_id)
        {
            ...
            if (!empty($skills_list)) { ?>
                <div class="pdf-style12-section-heading"><?php echo esc_html__('Skills', 'jobsearch-resume-export'); ?></div>
...
global $jobsearch_resume_pdf_template_eleven;
$jobsearch_resume_pdf_template_eleven = new jobsearch_candidate_pdf_resume_template_eleven();