<?php
if (!class_exists('jobsearch_candidate_pdf_resume_template_fourteen')) {

    class jobsearch_candidate_pdf_resume_template_fourteen
    {
        ...
        public function jobsearch_single_candidate_resume_form()
        {
            ...
            ?>
            <form id="pdf_cand_generate_form_templt_fourteen" method="post" enctype="multipart/form-data"
                  style="display: none">
                <input type="text" name="jobsearch_single_pdf_cand_id_templt_fourteen" value="">
                <input type="submit" class="btn btn-default" name="pdf_cand_generate_form_submit_templt_fourteen"
                       value="Generate PDF">
            </form>
            <script type="text/javascript">
                jQuery(document).on('click', '.jobsearch-get-cand-id-templt-fourteen', function () {
                    ...
                    request.done(function (response) {
                        if (typeof response.res !== 'undefined' && response.res == true) {
                            ...
                            //
                            jQuery("input[name=jobsearch_single_pdf_cand_id_templt_fourteen]").val(_cand_id);
                            jQuery("input[name=pdf_cand_generate_form_submit_templt_fourteen]").trigger('click')
                        }
                    });
        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_fourteen'])) {

                $candidate_id = $_POST['jobsearch_single_pdf_cand_id_templt_fourteen'];
                $stylesheet = file_get_contents($jobsearch_resume_export->jobsearch_resume_export_get_path('css/jobsearch-mpdf-style-template-fourteen.css'));
                ...
                <div class="pdf-style15-body" >
                    <div class="pdf-style15-left-content">
                        <?php if (!empty($profile_image)) { ?>
                            <div class="pdf-style15-main-thumb">
                                <div style="background-image: url('<?php echo($profile_image) ?>');"></div>
                            </div>
                        <?php } ?>
                        <div class="pdf-style15-thumb-description-border-top"></div>
                        <div class="pdf-style15-thumb-description">
                            <div class="pdf-style15-thumb-allison-title"><?php echo ($user_displayname) ?></div>
                            <div class="pdf-style15-thumb-title"><?php echo($candidate_company_str) ?></div>
                            <div class="pdf-style15-thumb-pera"><?php echo($candidate_content) ?>
                            </div>
                        </div>

                        <div class="pdf-style15-thumb-description-border-bottom"></div>
                        <br><br><br><br>
                        <div class="pdf-style15-social-list">
                            <?php if (!empty($user_dob_whole)) { ?>
                                <div class="pdf-style15-social-list-inn">
                                    <div class="pdf-style15-social-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_15/cake.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style15-social-text">
                                        <div class="pdf-style15-social-title"><?php echo esc_html__('DOB:', 'jobsearch-resume-export') ?></div>
                                        <div class="pdf-style15-social-sub"><?php echo($user_dob_whole) ?></div>
                                    </div>
                                </div>
                            <?php } ?>
                            <div class="pdf-style15-social-list-inn">
                                <div class="pdf-style15-social-icon"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_15/marker.png') ?>"
                                            alt=""></div>
                                <div class="pdf-style15-social-text">
                                    <div class="pdf-style15-social-title"><?php echo esc_html__('Address:', 'jobsearch-resume-export') ?></div>
                                    <div class="pdf-style15-social-sub"><?php echo($candidate_address) ?></div>
                                </div>
                            </div>
                            <?php if (!empty($phone_number)) { ?>
                                <div class="pdf-style15-social-list-inn">
                                    <div class="pdf-style15-social-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_15/phone.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style15-social-text">
                                        <div class="pdf-style15-social-title"><?php echo esc_html__('Phone:', 'jobsearch-resume-export') ?></div>
                                        <div class="pdf-style15-social-sub"><?php echo($phone_number) ?></div>
                                    </div>
                                </div>
                            <?php } ?>
                            <?php if (!empty($cand_email)) { ?>
                                <div class="pdf-style15-social-list-inn">
                                    <div class="pdf-style15-social-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_15/envelope.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style15-social-text">
                                        <div class="pdf-style15-social-title"><?php echo esc_html__('Email:', 'jobsearch-resume-export') ?></div>
                                        <div class="pdf-style15-social-sub"><?php echo($cand_email) ?></div>
                                    </div>
                                </div>
                            <?php } ?>
                            <?php if (!empty($user_website)) { ?>
                                <div class="pdf-style15-social-list-inn">
                                    <div class="pdf-style15-social-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_15/website.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style15-social-text">
                                        <div class="pdf-style15-social-title"><?php echo esc_html__('Website:', 'jobsearch-resume-export') ?></div>
                                        <div class="pdf-style15-social-sub"><?php echo($user_website) ?></div>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
                    ...
                    <div class="pdf-style15-right-content">
                ...
                <?php
                $footer_bg_image = $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_15/shape-bottom.png');
                $pdf_html = ob_get_clean();
                $mpdf->SetDefaultBodyCSS('background', "url('".$jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_15/pattren.png')."')");
                $mpdf->SetDefaultBodyCSS('background-image-resize', 6);
                $html_first_footer = '<div class="bottom-shape" style="background-image: url('.$footer_bg_image.');"></div>';
        ...
        public function jobsearch_candidate_resume_bulk_export_template_fourteen($candidate_id)
        {
        ...
        public static function jobsearch_resume_candidate_custom_fields($candidate_id)
        {
            ...
            if (!empty($custom_all_fields)) { ?>
                ...
                <div class="pdf-style14-bar-services">
                    <?php foreach ($custom_all_fields as $info) {
                        if (!empty($info['name'])) {
                            ...
                            <div class="pdf-style14-bar-services-list">
                                ...
                                <div class="pdf-style14-bar-services-text">
                                    <div class="pdf-style14-bar-services-title"><?php echo($info['label']) ?></div>
                                    <?php if (is_array($field_value) && count($field_value) > 0) {
                                        foreach ($field_value as $val) { ?>
                                            <div class="pdf-style14-bar-services-sub"><?php echo($val) ?></div>
                                        <?php }
                                    } else {
                                        $field_value = $info['type'] == 'date' ? date_i18n($info['date-format'],strtotime($field_value)) : $field_value;
        ...
        public function jobsearch_resume_candidate_experience($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style15-section-heading"><?php echo esc_html__('Experience', 'jobsearch-resume-export'); ?></div>
                        <div class="pdf-style15-content-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style15-content-list-inn">

                                <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                <div class="pdf-style15-content-list-date"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?></div>
                                <?php } else { ?>
                                <div class="pdf-style15-content-list-date"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . ($experience_end_datefield_val != '' ? ' - ' . date('Y', strtotime($experience_end_datefield_val)) : '') ?></div>
                                <?php } ?>

                                <div class="pdf-style15-content-list-circle"
                                     style="background: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_15/list-circle-15.png') ?>');"></div>
                                <div class="pdf-style15-content-list-text">
                                    <div class="pdf-style15-content-list-title"><?php echo jobsearch_esc_html($exfield) ?></div>
                                    <div class="pdf-style15-content-list-sub"><?php echo jobsearch_esc_html($experience_end_companyfield_val) ?></div>
                                    <div class="pdf-style15-content-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                                </div>
                            </div>
        ...
        public static function jobsearch_resume_candidate_education($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style15-section-heading"><?php echo esc_html__('Education', 'jobsearch-resume-export'); ?></div>
                  <div class="pdf-style15-content-list">
                          ...
                          <div class="pdf-style15-content-list-inn">
                           <?php if ($edu_start_metaexist) {
                                if ($education_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style15-content-list-date">
                                ...
                                <div class="pdf-style15-content-list-date"><?php echo($education_yearfield_val) ?></div>
                            <?php } ?>

                                <div class="pdf-style15-content-list-circle"
                                     style="background: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_15/list-circle-15.png') ?>')"></div>
                                <div class="pdf-style15-content-list-text">
                                    <div class="pdf-style15-content-list-title"><?php echo($education_yearfield_val) ?></div>
                                    <div class="pdf-style15-content-list-sub"><?php echo($exfield) ?></div>
                                    <div class="pdf-style15-content-list-pera"><?php echo($exfield_val) ?></div>
                                </div>
                            </div>
                        <?php $exfield_counter++;
                        $x++;
        ...
        public static function jobsearch_resume_candidate_awards($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style15-section-heading"><?php echo esc_html__('Honors & Awards', 'jobsearch-resume-export'); ?></div>
                  <div class="pdf-style15-content-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style15-content-list-inn">
                            <div class="pdf-style15-content-list-date"><?php echo jobsearch_esc_html($award_yearfield_val) ?></div>
                            <div class="pdf-style15-content-list-circle"></div>
                            <div class="pdf-style15-content-list-text">
                                <div class="pdf-style15-content-list-title"><?php echo($exfield) ?></div>
                                <div class="pdf-style15-content-list-sub">at Yellow inc.</div>
                                <div class="pdf-style15-content-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                            </div>
                        </div>
        ...
        public static function jobsearch_resume_candidate_expertise($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                    ...
                    <div class="pdf-style15-skills-heading"><?php echo esc_html__('My Expertise', 'jobsearch-resume-export') ?></div>
                    <div class="pdf-style15-skills-wrap">
                        <div class="pdf-style15-skills-circle">
                            <div></div>
                        </div>
                    <?php
                    $exfield_counter = 0;
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style15-skills-list">
                            <div class="pdf-style15-skills-title"><?php echo($exfield) ?></div>
                            <div class="pdf-style15-skills-line">
                                <div class="pdf-style15-skills-inn1"></div>
                                <div class="pdf-style15-skills-inn2" style="width: <?php echo($skill_percentagefield_val) ?>%;"></div>
                            </div>
                        </div>
                        <?php $exfield_counter++;
                        $x++;
        ...
        public static function jobsearch_resume_candidate_languages($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                    ...
                    <div class="pdf-style15-skills-heading"><?php echo esc_html__('Languages', 'jobsearch-resume-export') ?></div>
                    <div class="pdf-style15-skills-wrap">
                        <div class="pdf-style15-skills-circle">
                            <div></div>
                        </div>
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style15-skills-list">
                            <div class="pdf-style15-skills-title"><strong><?php echo($exfield) ?></strong> <?php echo($lang_level_str) ?></div>
                            <div class="pdf-style15-skills-line">
                                <div class="pdf-style15-skills-inn1"></div>
                                <div class="pdf-style15-skills-inn2" style="width: <?php echo($lang_percentagefield_val) ?>%;"></div>
                            </div>
                        </div>
        ...
        public static function jobsearch_resume_cand_portfolio($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style15-section-heading"><?php echo esc_html__('Portfolio', 'jobsearch-resume-export'); ?></div>
                  <div class="pdf-style15-content-list">
                    <?php
                    $exfield_counter = 0;
                    foreach ($exfield_list as $exfield) {
        ...
        public static function jobsearch_resume_candidate_skills($candidate_id)
        {
            ...
            if (!empty($skills_list)) { ?>
                    <div class="pdf-style15-skills-heading"><?php echo esc_html__('Skills', 'jobsearch-resume-export') ?></div>
                    <div class="pdf-style15-skills-wrap">
                        <div class="pdf-style15-skills-circle">
                            <div></div>
                        </div>
...
global $jobsearch_resume_pdf_template_fourteen;
$jobsearch_resume_pdf_template_fourteen = new jobsearch_candidate_pdf_resume_template_fourteen();