<?php
if (!class_exists('jobsearch_candidate_pdf_resume_template_nineteen')) {

    class jobsearch_candidate_pdf_resume_template_nineteen
    {
        ...
        public function jobsearch_single_candidate_resume_form()
        {
            ...
            ?>
            <form id="pdf_cand_generate_form_templt_nineteen" method="post" enctype="multipart/form-data"
                  style="display: none">
                <input type="text" name="jobsearch_single_pdf_cand_id_templt_nineteen" value="">
                <input type="submit" class="btn btn-default" name="pdf_cand_generate_form_submit_templt_nineteen"
                       value="Generate PDF">
            </form>
            <script type="text/javascript">
                jQuery(document).on('click', '.jobsearch-get-cand-id-templt-nineteen', function () {
                    ...
                    request.done(function (response) {
                        if (typeof response.res !== 'undefined' && response.res == true) {
                            ...
                            //
                            jQuery("input[name=jobsearch_single_pdf_cand_id_templt_nineteen]").val(_cand_id);
                            jQuery("input[name=pdf_cand_generate_form_submit_templt_nineteen]").trigger('click')
                        }
                    });
        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_nineteen'])) {

                $candidate_id = $_POST['jobsearch_single_pdf_cand_id_templt_nineteen'];
                $stylesheet = file_get_contents($jobsearch_resume_export->jobsearch_resume_export_get_path('css/jobsearch-mpdf-style-template-nineteen.css'));
                ...
                <div class="pdf-style20-body"
                     style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_20/bg-repeat.png') ?>');">
                    <div class="pdf-style20-left-bar-wrapper">
                        <div class="pdf-style20-left-bar">
                            <?php if (!empty($profile_image)) { ?>
                                <div class="pdf-style20-thumb">
                                    <div style="background-image: url('<?php echo($profile_image) ?>');"></div>
                                </div>
                            <?php } ?>
                            <?php if (!empty($cand_email)) { ?>
                                <div class="pdf-style20-bar-info">
                                    <div class="pdf-style20-bar-info-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_20/plane23.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style20-bar-info-text"><?php echo($cand_email) ?></div>
                                </div>
                            <?php } ?>
                            <?php if (!empty($phone_number)) { ?>
                                <div class="pdf-style20-bar-info">
                                    <div class="pdf-style20-bar-info-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_20/mobile23.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style20-bar-info-text">+<?php echo($phone_number) ?></div>
                                </div>
                            <?php } ?>
                            <?php if (!empty($user_email)) { ?>
                                <div class="pdf-style20-bar-info">
                                    <div class="pdf-style20-bar-info-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_20/world.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style20-bar-info-text"><?php echo($user_email) ?></div>
                                </div>
                            <?php } ?>

                            <div class="pdf-style20-bar-info">
                                <div class="pdf-style20-bar-info-icon"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_20/marker23.png') ?>"
                                            alt=""></div>
                                <div class="pdf-style20-bar-info-text"><?php echo($candidate_company_str) ?></div>
                            </div>
                            <br>
                            <!--Candidate Skills-->
                    ...
                    <div class="pdf-style20-content-section">
                        <div class="pdf-style20-content-title"><?php echo($user_firstname) ?>
                            <br><?php echo($user_last_name) ?></div>
                        <div class="pdf-style20-content-sub"><?php echo($candidate_company_str) ?></div>
                        <!--Candidate Custom Fields-->
                        <?php echo self::jobsearch_resume_candidate_custom_fields($candidate_id) ?>
                        <br>
                        <div class="pdf-style20-section-heading"><?php echo esc_html__('PROFILE', 'jobsearch-resume-export') ?></div>
                        <div class="pdf-style20-content-pera"><?php echo($candidate_content) ?></div>
        ...
        public function jobsearch_candidate_resume_bulk_export_template_nineteen($candidate_id)
        {
        ...
        public static function jobsearch_resume_candidate_custom_fields($candidate_id)
        {
            ...
            if (!empty($custom_all_fields)) { ?>
                <div class="pdf-style20-bar-services">
                <?php
                $fields_data = [];
                foreach ($custom_all_fields as $info) {
                    ...
                    <?php } else if ($type == 'checkbox' && $field_for_non_reg_user != 'admin_view_only') {
                        ...
                        <?php } else { ?>
                            <div class="pdf-style20-bar-services-list">
                                <div class="pdf-style20-bar-icon">
                                    <div style="font-family: <?php echo($icon_type) ?>"><?php echo jobsearch_get_font_code($icon) ?></div>
                                </div>
                                <div class="pdf-style20-bar-services-text">
                                    <div class="pdf-style20-bar-services-title"><?php echo($field_label) ?></div>
                                    <?php if (is_array($field_value) && count($field_value) > 0) {
                                        foreach ($field_value as $val) { ?>
                                            <div class="pdf-style20-bar-services-sub"><?php echo($val) ?></div>
                                        <?php }
                                    } else {
                                        $field_value = $type == 'date' ? date_i18n($info['date-format'], $field_value) : $field_value;
                                        ?>
                                        <div class="pdf-style20-bar-services-sub"><?php echo($field_value) ?></div>
                                    <?php } ?>
                                </div>
                            </div>
                        <?php } ?>
                ...
                if (count($fields_data) > 0) {
                    foreach ($fields_data as $fields) { ?>
                        <div class="pdf-style20-bar-services-list">
                            ...
                            <?php } ?>
                            <div class="pdf-style20-bar-services-text">
                                <div class="pdf-style20-bar-services-title"><?php echo($fields['label']) ?></div>
                                <div class="pdf-style20-bar-services-sub"><?php echo($fields['value']) ?></div>
                            </div>
                        </div>
                    <?php } ?>
                <?php } ?>
        ...
        public function jobsearch_resume_candidate_experience($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style20-section-heading"><?php echo esc_html__('EXPERIENCE', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style20-experience-list">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                    ...
                    foreach ($exfield_list as $key => $exfield) {
                        ...
                        ?>
                        <div class="pdf-style20-experience-inner">
                            <div class="pdf-style20-experience-circle">
                                <div style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_20/content-list-circle.png') ?>');"></div>
                            </div>
                            <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                <div class="pdf-style20-experience-title"><?php echo jobsearch_esc_html($exfield) ?>
                                    &nbsp; &nbsp;
                            ...
                            <?php } ?>
                            <div class="pdf-style20-experience-sub"><?php echo jobsearch_esc_html($experience_end_companyfield_val) ?></div>
                            <div class="pdf-style20-experience-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                        </div>
                        <?php
                        $exfield_counter++;
                        $x++;
        ...
        public static function jobsearch_resume_candidate_education($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style20-section-heading"><?php echo esc_html__('EDUCATION', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style20-experience-list">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                        ...
                        <div class="pdf-style20-experience-inner">
                            ...
                            <?php if ($edu_start_metaexist) {
                                if ($education_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style20-experience-title">
                                        <?php echo jobsearch_esc_html($exfield) ?>&nbsp;
                                ...
                                <div class="pdf-style20-experience-title"><?php echo($education_yearfield_val) ?></div>
                            <?php } ?>
                            <div class="pdf-style20-experience-sub"><?php echo($education_academyfield_val) ?></div>
                            <div class="pdf-style20-experience-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                        </div>
                        <?php $exfield_counter++;
                        $x++;
        ...
        public static function jobsearch_resume_candidate_awards($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style20-section-heading"><?php echo esc_html__('Honors & Awards', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style20-experience-list">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
        ...
        public static function jobsearch_resume_candidate_expertise($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style20-section-heading"><?php echo esc_html__('Expertise', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style20-skills-wrap">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style20-skills">
                            <div class="pdf-style20-skills-left"><?php echo($exfield) ?></div>
                            <div class="pdf-style20-skills-line">
                                <div class="pdf-style20-skills-inn1"></div>
                                <div class="pdf-style20-skills-inn2"
        ...
        public static function jobsearch_resume_candidate_languages($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style20-section-heading"><?php echo esc_html__('Languages', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style20-skills-wrap">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style20-skills">
                            <div class="pdf-style20-skills-left">
        ...
        public static function jobsearch_resume_cand_portfolio($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style20-section-heading"><?php echo esc_html__('Portfolio', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style20-experience-list">
                    <?php
                    $exfield_counter = 0;
                    foreach ($exfield_list as $exfield) {
        ...
        {
            global $jobsearch_resume_export;
            $bg_image = $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_20/list-circle23.png');
            $skills_list = jobsearch_resume_export_job_get_all_skills($candidate_id, '', '', '', '', '<div class="pdf-style20-bar-links"><div class="pdf-style20-bar-links-icon"><img src="' . ($bg_image) . '" ></div><div class="pdf-style20-bar-links-text">', '</div></div>', 'candidate');
            $skills_list = apply_filters('jobsearch_cand_detail_skills_list_html', $skills_list, $candidate_id);

            if (!empty($skills_list)) { ?>
                <div class="pdf-style20-bar-title"><?php echo esc_html__('Skills', 'jobsearch-resume-export') ?></div>
                <?php if ($skills_list != '') { ?>
...
global $jobsearch_resume_pdf_template_nineteen;
$jobsearch_resume_pdf_template_nineteen = new jobsearch_candidate_pdf_resume_template_nineteen();