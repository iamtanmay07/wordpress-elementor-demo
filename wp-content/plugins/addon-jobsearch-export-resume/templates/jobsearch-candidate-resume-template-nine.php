<?php
if (!class_exists('jobsearch_candidate_pdf_resume_template_nine')) {

    class jobsearch_candidate_pdf_resume_template_nine
    {
        ...
        public function jobsearch_single_candidate_resume_form()
        {
            ...
            ?>
            <form id="pdf_cand_generate_form_templt_nine" method="post" enctype="multipart/form-data"
                  style="display: none">
                <input type="text" name="jobsearch_single_pdf_cand_id_templt_nine" value="">
                <input type="submit" class="btn btn-default" name="pdf_cand_generate_form_submit_templt_nine"
                       value="Generate PDF">
            </form>
            <script type="text/javascript">
                jQuery(document).on('click', '.jobsearch-get-cand-id-templt-nine', function () {
                    ...
                    request.done(function (response) {
                        if (typeof response.res !== 'undefined' && response.res == true) {
                            ...
                            //
                            jQuery("input[name=jobsearch_single_pdf_cand_id_templt_nine]").val(_cand_id);
                            jQuery("input[name=pdf_cand_generate_form_submit_templt_nine]").trigger('click')
                        }
                    });
        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_nine'])) {

                $candidate_id = $_POST['jobsearch_single_pdf_cand_id_templt_nine'];
                $stylesheet = file_get_contents($jobsearch_resume_export->jobsearch_resume_export_get_path('css/jobsearch-mpdf-style-template-nine.css'));
                ...
                <div class="pdf-style10-left-bar">
                    <?php if (!empty($profile_image)) { ?>
                        <div class="pdf-style10-thumb">
                            <div style="background-image: url('<?php echo($profile_image) ?>');"></div>
                        </div>
                    <?php } ?>
                    <div class="pdf-style10-thumb-title"><?php echo($user_displayname) ?></div>
                    <div class="pdf-style10-thumb-sub"><?php echo($candidate_company_str) ?></div>

                    <div class="pdf-style10-leftbar-title"><?php echo esc_html__('Description', 'jobsearch-resume-export') ?></div>
                    <div class="pdf-style10-leftbar-pera"><?php echo($candidate_content) ?></div>

                    <div class="pdf-style10-leftbar-title"><?php echo esc_html__('Contact', 'jobsearch-resume-export') ?></div>
                    <?php if (!empty($phone_number)) { ?>
                        <div class="pdf-style10-bar-list">
                            <div class="pdf-style10-bar-list-title"><?php echo esc_html__('Phone:', 'jobsearch-resume-export') ?></div>
                            <div class="pdf-style10-bar-list-sub">+<?php echo($phone_number) ?></div>
                        </div>
                    <?php } ?>
                    <?php if (!empty($cand_email)) { ?>
                        <div class="pdf-style10-bar-list">
                            <div class="pdf-style10-bar-list-title"><?php echo esc_html__('Email:', 'jobsearch-resume-export') ?></div>
                            <div class="pdf-style10-bar-list-sub"><?php echo($cand_email) ?></div>
                        </div>
                    <?php } ?>
                    <?php if (!empty($user_website)) { ?>
                        <div class="pdf-style10-bar-list">
                            <div class="pdf-style10-bar-list-title"><?php echo esc_html__('Web:', 'jobsearch-resume-export') ?></div>
                            <div class="pdf-style10-bar-list-sub"><?php echo($user_website) ?></div>
                        </div>
                    <?php } ?>
                    <div class="pdf-style10-bar-list">
                        <div class="pdf-style10-bar-list-title"><?php echo esc_html__('Home:', 'jobsearch-resume-export') ?></div>
                        <div class="pdf-style10-bar-list-sub"><?php echo($candidate_address) ?></div>
                    </div>
                    <br><br>
                    ...
                    ?>
                    <div class="pdf-style10-leftbar-title"><?php echo esc_html__('Social Links:', 'jobsearch-resume-export') ?></div>
                    <?php if ($user_facebook_url != '' && $cand_alow_fb_smm == 'on') { ?>
                        <div class="pdf-style10-bar-list">
                            <div class="pdf-style10-bar-list-title"><?php echo esc_html__('Facebook:', 'jobsearch-resume-export') ?></div>
                            <div class="pdf-style10-bar-list-sub">
                    ...
                    <?php if ($user_dribbble_url != '' && $cand_alow_dribbb_smm == 'on') { ?>
                        <div class="pdf-style10-bar-list">
                            <div class="pdf-style10-bar-list-title"><?php echo esc_html__('Twitter:', 'jobsearch-resume-export') ?></div>
                            <div class="pdf-style10-bar-list-sub">
                    ...
                    <?php if ($user_linkedin_url != '' && $cand_alow_linkd_smm == 'on') { ?>
                        <div class="pdf-style10-bar-list">
                            <div class="pdf-style10-bar-list-title"><?php echo esc_html__('Linkedin:', 'jobsearch-resume-export') ?></div>
                            <div class="pdf-style10-bar-list-sub">
                ...
                <div class="pdf-style10-right-content">
        ...
        public function jobsearch_candidate_resume_bulk_export_template_nine($candidate_id)
        {
        ...
        public static function jobsearch_resume_candidate_custom_fields($candidate_id)
        {
            ...
            if (!empty($custom_all_fields)) {
                ...
                ?>
                <div class="pdf-style10-section-heading">
                    <div class="pdf-style10-section-heading-plus">
                        <div style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_10/plus.png') ?>');"></div>
                    </div>
                    <div class="pdf-style10-section-heading-text"><?php echo esc_html__('About Me', 'jobsearch-resume-export'); ?></div>
                    <div class="pdf-style10-section-heading-line">
                        <div></div>
                    </div>
                </div>
                <div class="pdf-style10-bar-services">
                <?php
                $fields_data = [];
                foreach ($custom_all_fields as $info) {
                    ...
                    if ($type == 'heading' && $field_for_non_reg_user != 'admin_view_only') { ?>
                        ...
                        <div class="pdf-style10-section-heading">
                            ...
                            <div class="pdf-style10-section-heading-text"><?php echo($field_label) ?></div>
                            <div class="pdf-style10-section-heading-line">
                                <div></div>
                            </div>
                        </div>
                        ...
                        <?php } else { ?>
                            <div class="pdf-style10-bar-services-list">
                                ...
                                <div class="pdf-style10-bar-services-text">
                                    <div class="pdf-style10-bar-services-title"><?php echo($info['label']) ?></div>
                                    <div class="pdf-style10-bar-services-sub">Institute</div>
                                    <?php if (is_array($field_value) && count($field_value) > 0) {
                                        foreach ($field_value as $val) { ?>
                                            <div class="pdf-style10-bar-services-sub"><?php echo($val) ?></div>
                                        <?php }
                                    } else {
                                        $field_value = $info['type'] == 'date' ? date_i18n($info['date-format'], $field_value) : $field_value;
                                        ?>
                                        <div class="pdf-style10-bar-services-sub"><?php echo($field_value) ?></div>
                                    <?php } ?>
                                </div>
                            </div>
                        <?php } ?>
        ...
        public function jobsearch_resume_candidate_experience($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style10-section-heading">
                    ...
                    <div class="pdf-style10-section-heading-text"><?php echo esc_html__('Experience', 'jobsearch-resume-export'); ?></div>
                    <div class="pdf-style10-section-heading-line">
                        <div></div>
                    </div>
                </div>
                <div class="pdf-style10-experience-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style10-experience-inner">
                            <div class="pdf-style10-experience-circle">
                                <div style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_10/circle.png') ?>');"></div>
                            </div>
                            <div class="pdf-style10-experience-title"><?php echo jobsearch_esc_html($exfield) ?></div>
                            <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                <div class="pdf-style10-experience-sub"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?></div>
                            <?php } else { ?>
                                <div class="pdf-style10-experience-sub"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . ($experience_end_datefield_val != '' ? ' - ' . date('Y', strtotime($experience_end_datefield_val)) : '') ?></div>
                            <?php } ?>
                            <div class="pdf-style10-experience-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                        </div>
        ...
        public static function jobsearch_resume_candidate_education($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style10-section-heading">
                    ...
                    <div class="pdf-style10-section-heading-text"><?php echo esc_html__('Education', 'jobsearch-resume-export'); ?></div>
                    <div class="pdf-style10-section-heading-line">
                        <div></div>
                    </div>
                </div>
                <div class="pdf-style10-experience-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style10-experience-inner">
                            ...
                            <div class="pdf-style10-experience-title"><?php echo($exfield) ?></div>
                            <?php
                            if ($edu_start_metaexist) {
                                if ($education_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style10-experience-sub"><?php echo ($education_start_datefield_val != '' ? date('Y', strtotime($education_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'wp-jobsearch') ?></div>
                                <?php } else { ?>
                                    <div class="pdf-style10-experience-sub"><?php echo ($education_start_datefield_val != '' ? date('Y', strtotime($education_start_datefield_val)) : '') . ($education_end_datefield_val != '' ? ' - ' . date('Y', strtotime($education_end_datefield_val)) : '') ?></div>
                                    <?php
                                }
                            } else { ?>
                                <div class="pdf-style10-experience-sub"><?php echo($education_yearfield_val) ?></div>
                            <?php } ?>
                            <div class="pdf-style10-experience-pera"><?php echo($exfield_val) ?></div>
                        </div>
                        <?php $exfield_counter++;
                        $x++;
                    } ?>
        ...
        public static function jobsearch_resume_candidate_awards($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style10-section-heading">
                    ...
                    <div class="pdf-style10-section-heading-text"><?php echo esc_html__('Honors & Awards', 'jobsearch-resume-export'); ?></div>
                    <div class="pdf-style10-section-heading-line">
                        <div></div>
                    </div>
                </div>
                <div class="pdf-style10-experience-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style10-experience-inner">
                            ...
                            <div class="pdf-style10-experience-title"><?php echo($exfield) ?></div>
                            <div class="pdf-style10-experience-sub"><?php echo jobsearch_esc_html($award_yearfield_val) ?></div>
                            <div class="pdf-style10-experience-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                        </div>
                        <?php $exfield_counter++;
                    } ?>
        ...
        public static function jobsearch_resume_candidate_expertise($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style10-section-heading">
                    ...
                    <div class="pdf-style10-section-heading-text"><?php echo esc_html__('Expertise', 'jobsearch-resume-export') ?></div>
                    <div class="pdf-style10-section-heading-line">
                        <div></div>
                    </div>
                </div>
                <div class="pdf-style10-skills-wrap">
                    <?php
                    $exfield_counter = 0;
                    $x = 1;
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style10-skills">
                            <div class="pdf-style10-skills-left"><?php echo($exfield) ?></div>
                            <div class="pdf-style10-skills-line">
                                <div class="pdf-style10-skills-inn1"></div>
                                <div class="pdf-style10-skills-inn2"
        ...
        public static function jobsearch_resume_candidate_languages($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style10-section-heading">
                    ...
                    <div class="pdf-style10-section-heading-text"><?php echo esc_html__('Languages', 'jobsearch-resume-export') ?></div>
                    <div class="pdf-style10-section-heading-line">
                        <div></div>
                    </div>
                </div>
                <div class="pdf-style10-skills-wrap">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style10-skills">
                            <div class="pdf-style10-skills-left">
        ...
        public static function jobsearch_resume_cand_portfolio($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style10-section-heading">
                    ...
                    <div class="pdf-style10-section-heading-text"><?php echo esc_html__('Portfolio', 'jobsearch-resume-export') ?></div>
                    <div class="pdf-style10-section-heading-line">
                        <div></div>
                    </div>
                </div>
        ...
        public static function jobsearch_resume_candidate_skills($candidate_id)
        {
            ...
            if (!empty($skills_list)) { ?>
                <div class="pdf-style10-leftbar-title"><?php echo esc_html__('Skills', 'jobsearch-resume-export') ?></div>
...
global $jobsearch_resume_pdf_template_nine;
$jobsearch_resume_pdf_template_nine = new jobsearch_candidate_pdf_resume_template_nine();