<?php
if (!class_exists('jobsearch_candidate_pdf_resume_template_thirteen')) {

    class jobsearch_candidate_pdf_resume_template_thirteen
    {
        ...
        public function jobsearch_single_candidate_resume_form()
        {
            ...
            ?>
            <form id="pdf_cand_generate_form_templt_thirteen" method="post" enctype="multipart/form-data"
                  style="display: none">
                <input type="text" name="jobsearch_single_pdf_cand_id_templt_thirteen" value="">
                <input type="submit" class="btn btn-default" name="pdf_cand_generate_form_submit_templt_thirteen"
                       value="Generate PDF">
            </form>
            <script type="text/javascript">
                jQuery(document).on('click', '.jobsearch-get-cand-id-templt-thirteen', function () {
                    ...
                    request.done(function (response) {
                        if (typeof response.res !== 'undefined' && response.res == true) {
                            ...
                            //
                            jQuery("input[name=jobsearch_single_pdf_cand_id_templt_thirteen]").val(_cand_id);
                            jQuery("input[name=pdf_cand_generate_form_submit_templt_thirteen]").trigger('click')
                        }
                    });
        ...
        public function jobsearch_single_candidate_resume_export_callback()
        {
            ...
            if (isset($_POST['pdf_cand_generate_form_submit_templt_thirteen'])) {

                $candidate_id = $_POST['jobsearch_single_pdf_cand_id_templt_thirteen'];
                $stylesheet = file_get_contents($jobsearch_resume_export->jobsearch_resume_export_get_path('css/jobsearch-mpdf-style-template-thirteen.css'));
                ...
                ob_start();
                ?>
                <div class="pdf-style14-solid-bar"></div>
                <div class="pdf-style14-left-bar">
                    <?php if (!empty($profile_image)) { ?>
                        <div class="pdf-style14-thumb">
                            <div style="background-image: url('<?php echo($profile_image) ?>');"></div>
                        </div>
                    <?php } ?>
                    <div class="pdf-style14-thumb-title"><?php echo esc_html__('what\'s up guys', 'jobsearch-resume-export') ?></div>
                    <div class="pdf-style14-thumb-pera"><?php echo($candidate_content) ?></div>

                    <div class="pdf-style14-left-bar-heading"><?php echo esc_html__('INFO', 'jobsearch-resume-export') ?></div>
                    <div class="pdf-style14-social-list">
                        <?php if (!empty($phone_number)) { ?>
                            <div class="pdf-style14-social-list-inn">
                                <div class="pdf-style14-social-icon"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_14/phone-17.png') ?>"
                                            alt=""></div>
                                <div class="pdf-style14-social-text">
                                    <div class="pdf-style14-social-title"><?php echo esc_html__('Phone', 'jobsearch-resume-export') ?></div>
                                    <div class="pdf-style14-social-sub">+<?php echo($phone_number) ?></div>
                                </div>
                            </div>
                        <?php } ?>
                        <?php if (!empty($cand_email)) { ?>
                            <div class="pdf-style14-social-list-inn">
                                <div class="pdf-style14-social-icon"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_14/envelope-17.png') ?>"
                                            alt=""></div>
                                <div class="pdf-style14-social-text">
                                    <div class="pdf-style14-social-title"><?php echo esc_html__('Email', 'jobsearch-resume-export') ?></div>
                                    <div class="pdf-style14-social-sub"><?php echo($cand_email) ?></div>
                                </div>
                            </div>
                        <?php } ?>
                        <?php if (!empty($user_website)) { ?>
                            <div class="pdf-style14-social-list-inn">
                                <div class="pdf-style14-social-icon"><img
                                            src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_14/arrow-17.png') ?>"
                                            alt=""></div>
                                <div class="pdf-style14-social-text">
                                    <div class="pdf-style14-social-title"><?php echo esc_html__('Website', 'jobsearch-resume-export') ?></div>
                                    <div class="pdf-style14-social-sub"><?php echo($user_website) ?></div>
                                </div>
                            </div>
                        <?php } ?>
                        <div class="pdf-style14-social-list-inn">
                            <div class="pdf-style14-social-icon"><img
                                        src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_14/marker-17.png') ?>"
                                        alt=""></div>
                            <div class="pdf-style14-social-text">
                                <div class="pdf-style14-social-title"><?php echo esc_html__('Address', 'jobsearch-resume-export') ?></div>
                                <div class="pdf-style14-social-sub"><?php echo($candidate_address) ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    if (!empty($candidate_social_mlinks) || ($cand_alow_fb_smm == 'on' || $cand_alow_twt_smm == 'on' || $cand_alow_gplus_smm == 'on' || $cand_alow_linkd_smm == 'on' || $cand_alow_dribbb_smm == 'on')) { ?>
                        ...
                        <div class="pdf-style14-left-bar-heading"><?php echo esc_html__('Social', 'jobsearch-resume-export') ?></div>
                        <div class="pdf-style14-social-list">

                            <?php if ($user_facebook_url != '' && $cand_alow_fb_smm == 'on') { ?>
                                <div class="pdf-style14-social-list-inn">
                                    <div class="pdf-style14-social-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_14/facebook-17.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style14-social-text">
                                        <div class="pdf-style14-social-title"><?php echo esc_html__('Facebook', 'jobsearch-resume-export') ?></div>
                                        <div class="pdf-style14-social-sub">
                            ...
                            <?php if ($user_twitter_url != '' && $cand_alow_twt_smm == 'on') { ?>
                                <div class="pdf-style14-social-list-inn">
                                    <div class="pdf-style14-social-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_14/dribble-17.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style14-social-text">
                                        <div class="pdf-style14-social-title"><?php echo esc_html__('Twitter', 'jobsearch-resume-export') ?></div>
                                        <div class="pdf-style14-social-sub"><a
                            ...
                            <?php if ($user_linkedin_url != '' && $cand_alow_linkd_smm == 'on') { ?>
                                <div class="pdf-style14-social-list-inn">
                                    <div class="pdf-style14-social-icon"><img
                                                src="<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_14/linkedin-17.png') ?>"
                                                alt=""></div>
                                    <div class="pdf-style14-social-text">
                                        <div class="pdf-style14-social-title"><?php echo esc_html__('LinkedIn', 'jobsearch-resume-export') ?></div>
                                        <div class="pdf-style14-social-sub"><a
                            ...
                            <?php if ($user_dribbble_url != '' && $cand_alow_dribbb_smm == 'on') { ?>
                                <div class="pdf-style14-social-list-inn">
                                    <div class="pdf-style14-social-icon"><img
                                                ...
                                                alt=""></div>
                                    <div class="pdf-style14-social-text">
                                        <div class="pdf-style14-social-title"><?php echo esc_html__('Dribbble', 'jobsearch-resume-export') ?></div>
                                        <div class="pdf-style14-social-sub">
                ...
                <div class="pdf-style14-right-content">
                    <div class="pdf-style14-top-title-bar">
                        <div class="pdf-style14-top-title-bar-title"><?php echo($user_firstname) ?>
                            <span><?php echo($user_last_name) ?></span></div>
                        <div class="pdf-style14-top-title-bar-sub"><?php echo esc_html__('I am a ', 'jobsearch-resume-export') ?>
                            <span><?php echo($candidate_company_str) ?></span></div>
                    </div>

                    <div class="pdf-style14-right-content-inner">
        ...
        public function jobsearch_candidate_resume_bulk_export_template_thirteen($candidate_id)
        {
                        ...
                        <?php if ($user_dribbble_url != '' && $cand_alow_dribbb_smm == 'on') { ?>
                            <div class="pdf-style14-social-list-inn">
                                <div class="pdf-style14-social-icon"><img
                                            ...
                                            alt=""></div>
                                <div class="pdf-style14-social-text">
                                    <div class="pdf-style14-social-title"><?php echo esc_html__('Dribble', 'jobsearch-resume-export') ?></div>
                                    <div class="pdf-style14-social-sub">
                                        <a href="<?php echo jobsearch_esc_html(esc_url($user_dribbble_url)) ?>"><?php echo jobsearch_esc_html(esc_url($user_dribbble_url)) ?></a>
                                    </div>
                                </div>
        ...
        public static function jobsearch_resume_candidate_custom_fields($candidate_id)
        {
            ...
            if (!empty($custom_all_fields)) { ?>
                <div class="pdf-style14-section-heading">
                    <div class="pdf-style14-section-heading-icon">
                        <div style="font-family: jobsearch">&#xe92f</div>
                    </div>
                    <div class="pdf-style14-section-heading-text"><?php echo esc_html__('About Me', 'jobsearch-resume-export'); ?></div>
                </div>
                <div class="pdf-style14-bar-services">
                <?php
                $fields_data = [];
                foreach ($custom_all_fields as $info) {
                    ...
                    if ($type == 'heading' && $field_for_non_reg_user != 'admin_view_only') { ?>
                        ...
                        <div class="pdf-style14-section-heading">
                            ...
                            <div class="pdf-style14-section-heading-text"><?php echo($field_label); ?></div>
                        </div>
                        <div class="pdf-style14-bar-services">
                    ...
                    <?php } else if ($type == 'checkbox' && $field_for_non_reg_user != 'admin_view_only') {
                        ...
                        if ($type == 'upload_file' && $field_for_non_reg_user != 'admin_view_only') {
                            if (is_array($field_value) && count($field_value) > 0) { ?>
                                <div class="pdf-stylefield-bar-servicesfull-list">
                                    <?php if (!empty($icon)) { ?>
                                        <div class="pdf-style14-bar-icon">
                                    ...
                                    <div class="pdf-stylefield-bar-servicesfull-text">
                                        <div class="pdf-style14-bar-services-title"><?php echo($field_label) ?></div>
                                    </div>
                                    <?php
                        ...
                        <?php } else { ?>
                            <div class="pdf-style14-bar-services-list">
                                <div class="pdf-style14-bar-icon">
                                    <div style="font-family: <?php echo($icon_type) ?>"><?php echo jobsearch_get_font_code($icon) ?></div>
                                </div>
                                <div class="pdf-style14-bar-services-text">
                                    <div class="pdf-style14-bar-services-title"><?php echo($field_label) ?></div>
                                    <?php if (is_array($field_value) && count($field_value) > 0) {
                                        foreach ($field_value as $val) { ?>
                                            <div class="pdf-style14-bar-services-sub"><?php echo($val) ?></div>
                                        <?php }
                                    } else {
                                        $field_value = $type == 'date' ? date_i18n($info['date-format'], $field_value) : $field_value;
                                        ?>
                                        <div class="pdf-style14-bar-services-sub"><?php echo($field_value) ?></div>
                                    <?php } ?>
                                </div>
                            </div>
                        <?php } ?>
                ...
                if (count($fields_data) > 0) {
                    foreach ($fields_data as $fields) { ?>
                        <div class="pdf-style14-bar-services-list">
                            ...
                            <?php } ?>
                            <div class="pdf-style14-bar-services-text">
                                <div class="pdf-style14-bar-services-title"><?php echo($fields['label']) ?></div>
                                <div class="pdf-style14-bar-services-sub"><?php echo($fields['value']) ?></div>
                            </div>
                        </div>
                    <?php } ?>
                <?php } ?>
        ...
        public function jobsearch_resume_candidate_experience($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style14-section-heading">
                    ...
                    <div class="pdf-style14-section-heading-text"><?php echo esc_html__('Work Experience', 'jobsearch-resume-export'); ?></div>
                </div>
                <div class="pdf-style14-content-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style14-content-list-inner">
                            <div class="pdf-style14-content-list-circle"
                                 style="background-image: url('<?php echo $jobsearch_resume_export->jobsearch_resume_export_get_path('images/template_14/circle-17.png') ?>');">
                                <div></div>
                            </div>
                            <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                <div class="pdf-style14-content-list-date"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?></div>
                            <?php } else { ?>
                                <div class="pdf-style14-content-list-date"><?php echo ($experience_start_datefield_val != '' ? date('Y', strtotime($experience_start_datefield_val)) : '') . ($experience_end_datefield_val != '' ? ' - ' . date('Y', strtotime($experience_end_datefield_val)) : '') ?></div>
                            <?php } ?>
                            <div class="pdf-style14-content-list-text">
                                <div class="pdf-style14-content-list-title"><?php echo jobsearch_esc_html($exfield) ?></div>
                                <div class="pdf-style14-content-list-sub"><?php echo jobsearch_esc_html($experience_end_companyfield_val) ?></div>
                                <div class="pdf-style14-content-list-pera"><?php echo jobsearch_esc_html($exfield_val) ?></div>
                            </div>
                        </div>
                        <?php
                        $exfield_counter++;
        ...
        public static function jobsearch_resume_candidate_education($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style14-section-heading">
                    <div class="pdf-style14-section-heading-icon">
                        <div style="font-family: jobsearch">&#xe931</div>
                    </div>
                    <div class="pdf-style14-section-heading-text"><?php echo esc_html__('Education', 'jobsearch-resume-export'); ?></div>
                </div>
                <div class="pdf-style14-content-list">
                    <?php
                    $exfield_counter = 0;
                        ...
                        <div class="pdf-style14-content-list-inner">
                            ...
                            <?php if ($edu_start_metaexist) {
                                if ($education_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style14-content-list-date">
                                        <?php echo ($education_start_datefield_val != '' ? date('Y', strtotime($education_start_datefield_val)) : '') . (' - ') . esc_html__('Present', 'wp-jobsearch') ?>
                                    </div>
                                <?php } else { ?>
                                    <div class="pdf-style14-content-list-date">
                                        <?php echo ($education_start_datefield_val != '' ? date('Y', strtotime($education_start_datefield_val)) : '') . ($education_end_datefield_val != '' ? ' - ' . date('Y', strtotime($education_end_datefield_val)) : '') ?>
                                    </div>
                                    <?php
                                }
                            } else { ?>
                                <div class="pdf-style14-content-list-date"><?php echo($education_yearfield_val) ?></div>
                            <?php } ?>
                            <div class="pdf-style14-content-list-text">
                                <div class="pdf-style14-content-list-title"><?php echo($exfield) ?></div>
                                <div class="pdf-style14-content-list-sub"><?php echo($education_academyfield_val) ?></div>
                                <div class="pdf-style14-content-list-pera"><?php echo($exfield_val) ?></div>
                            </div>
                        </div>
                        <?php $exfield_counter++;
                        $x++;
        ...
        public static function jobsearch_resume_candidate_awards($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style14-section-heading">
                    ...
                    <div class="pdf-style14-section-heading-text"><?php echo esc_html__('Honors & Awards', 'jobsearch-resume-export'); ?></div>
                </div>
                ...
                <div class="pdf-style14-content-list">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style14-content-list-inner">
                            ...
                            <div class="pdf-style14-content-list-date"><?php echo($award_yearfield_val) ?></div>
                            <div class="pdf-style14-content-list-text">
                                <div class="pdf-style14-content-list-title"><?php echo($exfield) ?></div>
                                <div class="pdf-style14-content-list-pera"><?php echo($exfield_val) ?></div>
                            </div>
        ...
        public static function jobsearch_resume_candidate_expertise($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                <div class="pdf-style14-left-bar-heading"><?php echo esc_html__('Expertise', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style14-skills-wrap">
                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style14-skills">
                            <div class="pdf-style14-skills-left"><?php echo($exfield) ?></div>
                            <div class="pdf-style14-skills-line">
                                <div class="pdf-style14-skills-inn1"></div>
                                <div class="pdf-style14-skills-inn2"
        ...
        public static function jobsearch_resume_candidate_languages($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style14-left-bar-heading"><?php echo esc_html__('Languages', 'jobsearch-resume-export') ?></div>
                <div class="pdf-style14-skills-wrap">
                    <?php
                    $exfield_counter = 0;
                    foreach ($exfield_list as $exfield) {
                        ...
                        ?>
                        <div class="pdf-style14-skills">
                            <div class="pdf-style14-skills-left">
        ...
        public static function jobsearch_resume_cand_portfolio($candidate_id)
        {
            ...
            if (is_array($exfield_list) && sizeof($exfield_list) > 0) { ?>
                ...
                <div class="pdf-style14-section-heading">
                    ...
                    <div class="pdf-style14-section-heading-text"><?php echo esc_html__('Portfolio', 'jobsearch-resume-export'); ?></div>
                </div>
                <div class="pdf-style14-content-list">
        ...
        public static function jobsearch_resume_candidate_skills($candidate_id)
        {
            ...
            if (!empty($skills_list)) { ?>
                <div class="pdf-style14-left-bar-heading"><?php echo esc_html__('Skills', 'jobsearch-resume-export'); ?></div>
...
global $jobsearch_resume_pdf_template_thirteen;
$jobsearch_resume_pdf_template_thirteen = new jobsearch_candidate_pdf_resume_template_thirteen();